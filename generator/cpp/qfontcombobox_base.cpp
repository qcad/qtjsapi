  ...
  // preceding Parameters: -1
      ...
      void QFontComboBox_Base::mouseMoveEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QFontComboBox_Base::mouseMoveEvent()";
...
event
  ...
  void QFontComboBox_Base::actionEvent(
      QActionEvent* event
    ) {

      //qDebug() << "QFontComboBox_Base::actionEvent()";
...
event
  ...
  void QFontComboBox_Base::resizeEvent(
      QResizeEvent* e
    ) {

      //qDebug() << "QFontComboBox_Base::resizeEvent()";
...
e
  ...
  void QFontComboBox_Base::paintEvent(
      QPaintEvent* e
    ) {

      //qDebug() << "QFontComboBox_Base::paintEvent()";
