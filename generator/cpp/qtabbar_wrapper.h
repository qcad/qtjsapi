  ...
  #include "RJSWrapperObj.h"
    ...
    #include "RJSType.h"
      ...
      class QTabBar_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
  ...
  a2
    ...
    class QTabBar_Wrapper : public RJSWrapperObj {
  ...
  Q_PROPERTY(
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static QTabBar* castToBase(void* vp, /*RJSType::WrappedType*/ int t) {
          switch (t) {
