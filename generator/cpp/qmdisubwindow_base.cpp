  ...
  // preceding Parameters: -1
      ...
      void QMdiSubWindow_Base::mousePressEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QMdiSubWindow_Base::mousePressEvent()";
...
event
  ...
  void QMdiSubWindow_Base::mouseReleaseEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QMdiSubWindow_Base::mouseReleaseEvent()";
...
event
  ...
  void QMdiSubWindow_Base::actionEvent(
      QActionEvent* event
    ) {

      //qDebug() << "QMdiSubWindow_Base::actionEvent()";
