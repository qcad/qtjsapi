   ...
   && a3.isUndefined()
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QTableWidgetItem(
              handler, 
              // non-copyable: true
                  res
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QTableWidget(
              handler, 
              // non-copyable: false
                  // return type is pointer, type is copyable:
                  // call pointer implementation of cpp2js_QTableWidget:
                  res
...
int a1_cpp;
    ...
    // call function:
      ...
      // check parameter types:
      if (
        is_Qt_AlignmentFlag(handler, a1
  )
...
Qt::AlignmentFlag a1_cpp;
      ...
      a1_cpp = js2cpp_Qt_AlignmentFlag(handler, a1);
...
QVariant a2_cpp;
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QTableWidgetItem_ptr(handler, a1
  )
  ...
  // convert js parameter to cpp: other (QTableWidgetItem)
      ...
      a1_cpp = js2cpp_QTableWidgetItem_ptr(handler, a1);
...
int a2_cpp;
  ...
  a3
   ...
   && is_QTableWidgetItem_ptr(handler, a3
    , true
...
int a2_cpp;
  ...
  // convert js parameter to cpp: item (QTableWidgetItem)
      ...
      a3_cpp = js2cpp_QTableWidgetItem_ptr(handler, a3);
...
int a1_cpp;
  ...
  a2
   ...
   && is_QTableWidgetItem_ptr(handler, a2
    , true
...
int a1_cpp;
  ...
  // convert js parameter to cpp: item (QTableWidgetItem)
      ...
      a2_cpp = js2cpp_QTableWidgetItem_ptr(handler, a2);
...
QItemSelectionModel::SelectionFlags a2_cpp;
  ...
  a3
   ...
   && is_QItemSelectionModel_SelectionFlags(handler, a3
  )
...
QItemSelectionModel::SelectionFlags a3_cpp;
      ...
      a3_cpp = js2cpp_QItemSelectionModel_SelectionFlags(handler, a3);
...
int a1_cpp;
  ...
  QJSValue a1_js = cpp2js_QTableWidgetItem(
    handler, 
    item
  );
  ...
  QJSValue a2_js = cpp2js_QTableWidgetItem(
    handler, 
    previous
  );
