...
int a1_cpp;
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QList_QWidget_ptr(handler, a1
  )
...
QList<QWidget*> a1_cpp;
      ...
      a1_cpp = js2cpp_QList_QWidget_ptr(handler, a1);
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QAbstractPrintDialog_PrintRange(handler, a1
  )
...
QAbstractPrintDialog::PrintRange a1_cpp;
      ...
      a1_cpp = js2cpp_QAbstractPrintDialog_PrintRange(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QAbstractPrintDialog_PrintRange(
              handler, 
              // non-copyable: false
                  res
