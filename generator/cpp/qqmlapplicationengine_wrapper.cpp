  ...
  //#include "header_cpp.h"
    ...
    */
      ...
      QQmlApplicationEngine_Wrapper::QQmlApplicationEngine_Wrapper(RJSApi& h, QQmlApplicationEngine* o, bool wrappedCreated) : RJSWrapperObj(h), 
  ...
  // convert js parameter to cpp: parent (QObject)
   ...
   && a2.isUndefined()
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              QQmlApplicationEngine_Wrapper::eventFilter
              (
...
QUrl a2_cpp;
  ...
  // protected overwritten functions / events and their public invokable counterparts:
    ...
    #include "moc_qqmlapplicationengine_wrapper.cpp"
