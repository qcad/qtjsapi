  ...
  // preceding Parameters: 2
      ...
      void QTextEdit_Base::actionEvent(
      QActionEvent* event
    ) {

      //qDebug() << "QTextEdit_Base::actionEvent()";
...
event
  ...
  void QTextEdit_Base::setViewportMargins(
      int left, int top, int right, int bottom
    ) {

      //qDebug() << "QTextEdit_Base::setViewportMargins()";
...
margins
  ...
  QMargins QTextEdit_Base::viewportMargins(
      
    ) {

      //qDebug() << "QTextEdit_Base::viewportMargins()";
  ...
  bool QTextEdit_Base::eventFilter(
      QObject* a1, QEvent* a2
    ) {

      //qDebug() << "QTextEdit_Base::eventFilter()";
...
a2
  ...
  bool QTextEdit_Base::viewportEvent(
      QEvent* a1
    ) {

      //qDebug() << "QTextEdit_Base::viewportEvent()";
...
a1
  ...
  QSize QTextEdit_Base::viewportSizeHint(
      
    ) {

      //qDebug() << "QTextEdit_Base::viewportSizeHint()";
