...
int a3_cpp;
  ...
  // convert js parameter to cpp:  (QWidget)
    ...
    void QToolBar_Wrapper::init(RJSApi& handler) {
      ...
      QString fileName = ":generated/js/QToolBar.js";
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                if (wb==nullptr) {
                  qWarning() << "QToolBar::mousePressEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QToolBar_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QToolBar::mouseReleaseEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QToolBar_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QToolBar::actionEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
...
Qt::ToolBarAreas a1_cpp;
      ...
      a1_cpp = js2cpp_Qt_ToolBarAreas(handler, a1);
...
QString a2_cpp;
  ...
  // convert js parameter to cpp: member (char)
      ...
      // char pointer string:
      QByteArray a4_ba = js2cpp_char_ptr(handler, a4).toLocal8Bit();
...
Qt::ToolButtonStyle a1_cpp;
  ...
  QJSValue a1_js = cpp2js_Qt_ToolBarAreas(
    handler, 
    allowedAreas
  );
