...
QList<QByteArray> a1_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              QSslConfiguration_Wrapper::keyingMaterial
              (
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                // call function of C++ class:
                QSslConfiguration* w = getWrapped();
                QList<QSslKeyingMaterial> res = 
                    
                w->keyingMaterial(
                  
                );
              
            // return type: QList<QSslKeyingMaterial>

            return RJSHelper::cpp2js_QList_QSslKeyingMaterial(
              handler, 
              // non-copyable: false
                  res
                  ...
                  qWarning() << "no matching function variant found for keyingMaterial";
                  handler.trace();
                  return QJSValue();
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              QSslConfiguration_Wrapper::setKeyingMaterial
              (
  ...
  a1
      ...
      // check parameter types:
      if (
        RJSHelper::is_QList_QSslKeyingMaterial(handler, a1
  )
  ...
  // convert js parameter to cpp: keyMaterial (QList<QSslKeyingMaterial>)
  
QList<QSslKeyingMaterial> a1_cpp;

      a1_cpp = RJSHelper::js2cpp_QList_QSslKeyingMaterial(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return QJSValue();
                  ...
                  qWarning() << "no matching function variant found for setKeyingMaterial";
                  handler.trace();
                  return QJSValue();
