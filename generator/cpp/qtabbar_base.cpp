  ...
  // preceding Parameters: -1
      ...
      void QTabBar_Base::mousePressEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QTabBar_Base::mousePressEvent()";
...
event
  ...
  void QTabBar_Base::mouseReleaseEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QTabBar_Base::mouseReleaseEvent()";
...
event
  ...
  void QTabBar_Base::actionEvent(
      QActionEvent* event
    ) {

      //qDebug() << "QTabBar_Base::actionEvent()";
