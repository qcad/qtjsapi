...
QItemSelectionModel::SelectionFlags a2_cpp;
  ...
  QJSValue a1_js = cpp2js_QItemSelection(
    handler, 
    selected
  );
  ...
  QJSValue a2_js = cpp2js_QItemSelection(
    handler, 
    deselected
  );
  ...
  QJSValue a2_js = cpp2js_QModelIndex(
    handler, 
    previous
  );
  ...
  QJSValue a1_js = cpp2js_QAbstractItemModel(
    handler, 
    model
  );
