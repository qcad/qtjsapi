  ...
  // convert js parameter to cpp: parent (QListWidget)
         ...
         a3_cpp;
          ...
          if (a3.isUndefined()) {
            ...
            a3_cpp = js2cpp_QListWidget_ptr(handler, a3);
          }
  ...
  // convert js parameter to cpp: parent (QListWidget)
         ...
         a2_cpp;
          ...
          if (a2.isUndefined()) {
            ...
            a2_cpp = js2cpp_QListWidget_ptr(handler, a2);
          }
  ...
  // convert js parameter to cpp: parent (QListWidget)
         ...
         a1_cpp;
          ...
          if (a1.isUndefined()) {
            ...
            a1_cpp = js2cpp_QListWidget_ptr(handler, a1);
          }
...
Qt::WidgetAttribute a1_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              QListWidget_Wrapper::paintEngine
              (
...
QModelIndex a1_cpp;
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QListView_Movement(handler, a1
  )
...
QListView::Movement a1_cpp;
      ...
      a1_cpp = js2cpp_QListView_Movement(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QListView_Movement(
              handler, 
              // non-copyable: false
                  res
...
QListView::Flow a1_cpp;
      ...
      a1_cpp = js2cpp_QListView_Flow(handler, a1);
...
bool a1_cpp;
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QListView_ResizeMode(handler, a1
  )
...
QListView::ResizeMode a1_cpp;
      ...
      a1_cpp = js2cpp_QListView_ResizeMode(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QListView_ResizeMode(
              handler, 
              // non-copyable: false
                  res
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QListView_LayoutMode(handler, a1
  )
...
QListView::LayoutMode a1_cpp;
      ...
      a1_cpp = js2cpp_QListView_LayoutMode(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QListView_LayoutMode(
              handler, 
              // non-copyable: false
                  res
...
QSize a1_cpp;
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QListView_ViewMode(handler, a1
  )
...
QListView::ViewMode a1_cpp;
      ...
      a1_cpp = js2cpp_QListView_ViewMode(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QListView_ViewMode(
              handler, 
              // non-copyable: false
                  res
...
int a1_cpp;
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QListWidgetItem_ptr(handler, a1
    , true
  ...
  // convert js parameter to cpp: item (QListWidgetItem)
      ...
      a1_cpp = js2cpp_QListWidgetItem_ptr(handler, a1);
  ...
  a2
   ...
   && is_QListWidgetItem_ptr(handler, a2
    , true
...
int a1_cpp;
  ...
  // convert js parameter to cpp: item (QListWidgetItem)
      ...
      a2_cpp = js2cpp_QListWidgetItem_ptr(handler, a2);
...
Qt::SortOrder a1_cpp;
          ...
          if (a1.isUndefined()) {
            ...
            a1_cpp = js2cpp_Qt_SortOrder(handler, a1);
          }
  ...
  // convert js parameter to cpp: item (QListWidgetItem)
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QList_QListWidgetItem_ptr(
              handler, 
              // non-copyable: false
                  res
...
QAbstractItemView::ScrollHint a2_cpp;
  ...
  QJSValue a1_js = cpp2js_QListWidgetItem(
    handler, 
    item
  );
  ...
  QJSValue a2_js = cpp2js_QListWidgetItem(
    handler, 
    previous
  );
