...
QSize a2_cpp;
    ...
    void QFormLayout_Wrapper::init(RJSApi& handler) {
      ...
      QString fileName = ":generated/js/QFormLayout.js";
...
Qt::Alignment a2_cpp;
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QLayout_SizeConstraint(handler, a1
  )
...
QLayout::SizeConstraint a1_cpp;
      ...
      a1_cpp = js2cpp_QLayout_SizeConstraint(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QLayout_SizeConstraint(
              handler, 
              // non-copyable: false
                  res
...
bool a1_cpp;
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QFormLayout_FieldGrowthPolicy(handler, a1
  )
...
QFormLayout::FieldGrowthPolicy a1_cpp;
      ...
      a1_cpp = js2cpp_QFormLayout_FieldGrowthPolicy(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QFormLayout_FieldGrowthPolicy(
              handler, 
              // non-copyable: false
                  res
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QFormLayout_RowWrapPolicy(handler, a1
  )
...
QFormLayout::RowWrapPolicy a1_cpp;
      ...
      a1_cpp = js2cpp_QFormLayout_RowWrapPolicy(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QFormLayout_RowWrapPolicy(
              handler, 
              // non-copyable: false
                  res
...
int a1_cpp;
  ...
  // convert js parameter to cpp: field (QLayout)
      ...
      a2_cpp = js2cpp_QLayout_ptr(handler, a2);
...
int a1_cpp;
  ...
  // convert js parameter to cpp: field (QLayout)
      ...
      a3_cpp = js2cpp_QLayout_ptr(handler, a3);
...
int a1_cpp;
  ...
  a3
   ...
   && is_QFormLayout_ItemRole(handler, a2
  )

   && is_QLayoutItem_ptr(handler, a3
    , true
...
QFormLayout::ItemRole a2_cpp;
      ...
      a2_cpp = js2cpp_QFormLayout_ItemRole(handler, a2);
  ...
  // convert js parameter to cpp: item (QLayoutItem)
      ...
      a3_cpp = js2cpp_QLayoutItem_ptr(handler, a3);
...
int a1_cpp;
  ...
  // convert js parameter to cpp: item (QLayoutItem)
      ...
      a1_cpp = js2cpp_QLayoutItem_ptr(handler, a1);
