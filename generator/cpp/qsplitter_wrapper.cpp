...
int a3_cpp;
  ...
  // convert js parameter to cpp:  (QWidget)
    ...
    void QSplitter_Wrapper::init(RJSApi& handler) {
      ...
      QString fileName = ":generated/js/QSplitter.js";
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                if (wb==nullptr) {
                  qWarning() << "QSplitter::mousePressEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QSplitter_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QSplitter::mouseReleaseEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QSplitter_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QSplitter::actionEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QSplitter_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QSplitter::paintEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QSplitter_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QSplitter::mouseMoveEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
...
QList<int> a1_cpp;
      ...
      a1_cpp = js2cpp_QList_int(handler, a1);
...
int a2_cpp;
  ...
  // convert js parameter to cpp:  (QWidget)
    ...
    void QSplitterHandle_Wrapper::init(RJSApi& handler) {
      ...
      QString fileName = ":generated/js/QSplitterHandle.js";
      QFile scriptFile(fileName);
      if (!scriptFile.open(QIODevice::ReadOnly)) {
        qWarning() << "JS script wrapper file not found:" << fileName;
        return;
...
Qt::Orientation a1_cpp;
  ...
  // convert js parameter to cpp: parent (QSplitter)
      ...
      a2_cpp = js2cpp_QSplitter_ptr(handler, a2);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                if (wb==nullptr) {
                  qWarning() << "QSplitterHandle::actionEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
