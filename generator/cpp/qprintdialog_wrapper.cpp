...
int a1_cpp;
  ...
  a2
      ...
      // check parameter types:
      if (
        is_QAbstractPrintDialog_PrintDialogOption(handler, a1
  )
...
QAbstractPrintDialog::PrintDialogOption a1_cpp;
      ...
      a1_cpp = js2cpp_QAbstractPrintDialog_PrintDialogOption(handler, a1);
...
QAbstractPrintDialog::PrintDialogOption a1_cpp;
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QAbstractPrintDialog_PrintDialogOptions(handler, a1
  )
...
QAbstractPrintDialog::PrintDialogOptions a1_cpp;
      ...
      a1_cpp = js2cpp_QAbstractPrintDialog_PrintDialogOptions(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QAbstractPrintDialog_PrintDialogOptions(
              handler, 
              // non-copyable: false
                  res
...
bool a1_cpp;
  ...
  QJSValue a1_js = cpp2js_QPrinter(
    handler, 
    printer
  );
