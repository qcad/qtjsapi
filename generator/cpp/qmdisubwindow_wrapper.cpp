...
Qt::WidgetAttribute a1_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              QMdiSubWindow_Wrapper::paintEngine
              (
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                if (wb==nullptr) {
                  qWarning() << "QMdiSubWindow::mousePressEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QMdiSubWindow_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QMdiSubWindow::mouseReleaseEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QMdiSubWindow_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QMdiSubWindow::actionEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
...
Qt::InputMethodHints a1_cpp;
  ...
  a2
      ...
      // check parameter types:
      if (
        is_QMdiSubWindow_SubWindowOption(handler, a1
  )
...
QMdiSubWindow::SubWindowOption a1_cpp;
      ...
      a1_cpp = js2cpp_QMdiSubWindow_SubWindowOption(handler, a1);
...
int a1_cpp;
  ...
  QJSValue a1_js = cpp2js_Qt_WindowStates(
    handler, 
    oldState
  );
  ...
  QJSValue a2_js = cpp2js_Qt_WindowStates(
    handler, 
    newState
  );
