  ...
  // preceding Parameters: -1
      ...
      void QMainWindow_Base::mousePressEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QMainWindow_Base::mousePressEvent()";
...
event
  ...
  void QMainWindow_Base::mouseReleaseEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QMainWindow_Base::mouseReleaseEvent()";
...
event
  ...
  void QMainWindow_Base::mouseMoveEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QMainWindow_Base::mouseMoveEvent()";
...
event
  ...
  void QMainWindow_Base::paintEvent(
      QPaintEvent* event
    ) {

      //qDebug() << "QMainWindow_Base::paintEvent()";
...
event
  ...
  void QMainWindow_Base::resizeEvent(
      QResizeEvent* event
    ) {

      //qDebug() << "QMainWindow_Base::resizeEvent()";
...
event
  ...
  void QMainWindow_Base::actionEvent(
      QActionEvent* event
    ) {

      //qDebug() << "QMainWindow_Base::actionEvent()";
