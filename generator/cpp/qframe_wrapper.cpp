...
int a3_cpp;
  ...
  // convert js parameter to cpp:  (QWidget)
    ...
    void QFrame_Wrapper::init(RJSApi& handler) {
      ...
      QString fileName = ":generated/js/QFrame.js";
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                if (wb==nullptr) {
                  qWarning() << "QFrame::mousePressEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QFrame_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QFrame::mouseReleaseEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QFrame_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QFrame::actionEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
