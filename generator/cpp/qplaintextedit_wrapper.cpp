...
int a3_cpp;
  ...
  // convert js parameter to cpp:  (QWidget)
    ...
    void QPlainTextEdit_Wrapper::init(RJSApi& handler) {
      ...
      QString fileName = ":generated/js/QPlainTextEdit.js";
...
Qt::WidgetAttribute a1_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              QPlainTextEdit_Wrapper::paintEngine
              (
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                if (wb==nullptr) {
                  qWarning() << "QPlainTextEdit::actionEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QPlainTextEdit_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QPlainTextEdit::setViewportMargins: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
...
QMargins a1_cpp;
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QPlainTextEdit_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QPlainTextEdit::viewportMargins: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QPlainTextEdit_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QPlainTextEdit::eventFilter: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QPlainTextEdit_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QPlainTextEdit::viewportEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QPlainTextEdit_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QPlainTextEdit::viewportSizeHint: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QTextDocument_ptr(handler, a1
    , true
  ...
  // convert js parameter to cpp: document (QTextDocument)
      ...
      a1_cpp = js2cpp_QTextDocument_ptr(handler, a1);
...
QTextCursor a1_cpp;
      ...
      a1_cpp = js2cpp_QTextCursor(handler, a1);
...
bool a1_cpp;
  ...
  a1
      ...
      // check parameter types:
      if (
        is_Qt_TextInteractionFlags(handler, a1
  )
...
Qt::TextInteractionFlags a1_cpp;
      ...
      a1_cpp = js2cpp_Qt_TextInteractionFlags(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_Qt_TextInteractionFlags(
              handler, 
              // non-copyable: false
                  res
...
QTextCharFormat a1_cpp;
      ...
      a1_cpp = js2cpp_QTextCharFormat(handler, a1);
...
int a1_cpp;
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QPlainTextEdit_LineWrapMode(
              handler, 
              // non-copyable: false
                  res
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QPlainTextEdit_LineWrapMode(handler, a1
  )
...
QPlainTextEdit::LineWrapMode a1_cpp;
      ...
      a1_cpp = js2cpp_QPlainTextEdit_LineWrapMode(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QTextOption_WrapMode(
              handler, 
              // non-copyable: false
                  res
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QTextOption_WrapMode(handler, a1
  )
...
QTextOption::WrapMode a1_cpp;
      ...
      a1_cpp = js2cpp_QTextOption_WrapMode(handler, a1);
...
bool a1_cpp;
  ...
  a2
   ...
   && is_QTextDocument_FindFlags(handler, a2
    , true
...
QTextDocument::FindFlags a2_cpp;
          ...
          if (a2.isUndefined()) {
            ...
            a2_cpp = js2cpp_QTextDocument_FindFlags(handler, a2);
          }
...
int a1_cpp;
  ...
  a2
      ...
      // check parameter types:
      if (
        is_QTextCursor_MoveOperation(handler, a1
  )

   && is_QTextCursor_MoveMode(handler, a2
    , true
...
QTextCursor::MoveOperation a1_cpp;
      ...
      a1_cpp = js2cpp_QTextCursor_MoveOperation(handler, a1);
...
QTextCursor::MoveMode a2_cpp;
          ...
          if (a2.isUndefined()) {
            ...
            a2_cpp = js2cpp_QTextCursor_MoveMode(handler, a2);
          }
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QPagedPaintDevice_ptr(handler, a1
    , true
  ...
  // convert js parameter to cpp: printer (QPagedPaintDevice)
      ...
      a1_cpp = js2cpp_QPagedPaintDevice_ptr(handler, a1);
