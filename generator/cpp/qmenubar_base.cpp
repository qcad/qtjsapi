  ...
  // preceding Parameters: -1
      ...
      void QMenuBar_Base::mousePressEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QMenuBar_Base::mousePressEvent()";
...
event
  ...
  void QMenuBar_Base::mouseReleaseEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QMenuBar_Base::mouseReleaseEvent()";
...
event
  ...
  void QMenuBar_Base::actionEvent(
      QActionEvent* event
    ) {

      //qDebug() << "QMenuBar_Base::actionEvent()";
