  ...
  // preceding Parameters: -1
      ...
      void QFrame_Base::mousePressEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QFrame_Base::mousePressEvent()";
...
event
        ...
        QFrame::mousePressEvent(
          event
        );
      }
    }

  void QFrame_Base::mouseReleaseEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QFrame_Base::mouseReleaseEvent()";
...
event
        ...
        QFrame::mouseReleaseEvent(
          event
        );
      }
    }

  void QFrame_Base::actionEvent(
      QActionEvent* event
    ) {

      //qDebug() << "QFrame_Base::actionEvent()";
