...
int a3_cpp;
  ...
  // convert js parameter to cpp:  (QWidget)
    ...
    void QDockWidget_Wrapper::init(RJSApi& handler) {
      ...
      QString fileName = ":generated/js/QDockWidget.js";
...
Qt::WindowFlags a3_cpp;
          ...
          if (a3.isUndefined()) {
            ...
            a3_cpp = js2cpp_Qt_WindowFlags(handler, a3);
          }
...
Qt::WidgetAttribute a1_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              QDockWidget_Wrapper::paintEngine
              (
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                if (wb==nullptr) {
                  qWarning() << "QDockWidget::mousePressEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QDockWidget_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QDockWidget::mouseReleaseEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QDockWidget_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QDockWidget::actionEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
...
Qt::InputMethodHints a1_cpp;
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QDockWidget_DockWidgetFeatures(handler, a1
  )
...
QDockWidget::DockWidgetFeatures a1_cpp;
      ...
      a1_cpp = js2cpp_QDockWidget_DockWidgetFeatures(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QDockWidget_DockWidgetFeatures(
              handler, 
              // non-copyable: false
                  res
...
Qt::DockWidgetAreas a1_cpp;
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_Qt_DockWidgetAreas(
              handler, 
              // non-copyable: false
                  res
...
Qt::DockWidgetArea a1_cpp;
  ...
  QJSValue a1_js = cpp2js_QDockWidget_DockWidgetFeatures(
    handler, 
    features
  );
  ...
  QJSValue a1_js = cpp2js_Qt_DockWidgetAreas(
    handler, 
    allowedAreas
  );
  ...
  QJSValue a1_js = cpp2js_Qt_DockWidgetArea(
    handler, 
    area
  );
