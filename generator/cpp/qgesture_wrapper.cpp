...
QPointF a1_cpp;
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QGesture_GestureCancelPolicy(handler, a1
  )
...
QGesture::GestureCancelPolicy a1_cpp;
      ...
      a1_cpp = js2cpp_QGesture_GestureCancelPolicy(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QGesture_GestureCancelPolicy(
              handler, 
              // non-copyable: false
                  res
...
QGesture::GestureCancelPolicy a1_cpp;
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QPinchGesture_ChangeFlags(
              handler, 
              // non-copyable: false
                  res
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QPinchGesture_ChangeFlags(handler, a1
  )
...
QPinchGesture::ChangeFlags a1_cpp;
      ...
      a1_cpp = js2cpp_QPinchGesture_ChangeFlags(handler, a1);
...
QGesture::GestureCancelPolicy a1_cpp;
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QSwipeGesture_SwipeDirection(
              handler, 
              // non-copyable: false
                  res
