  ...
  #include "RJSWrapperObj.h"
    ...
    #include "RJSType.h"
      ...
      class QMainWindow_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
  ...
  a2
    ...
    class QMainWindow_Wrapper : public RJSWrapperObj {
  ...
  Q_PROPERTY(
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static QMainWindow* castToBase(void* vp, /*RJSType::WrappedType*/ int t) {
          switch (t) {
