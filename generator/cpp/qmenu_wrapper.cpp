  ...
  // convert js parameter to cpp: parent (QWidget)
         ...
         a4_cpp;
          ...
          if (a4.isUndefined()) {
            ...
            a4_cpp = js2cpp_QWidget_ptr(handler, a4);
          }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                if (wb==nullptr) {
                  qWarning() << "QMenu::actionEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
...
QString a1_cpp;
  ...
  // convert js parameter to cpp: menu (QMenu)
      ...
      a2_cpp = js2cpp_QMenu_ptr(handler, a2);
