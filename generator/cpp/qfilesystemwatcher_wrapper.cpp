  ...
  //#include "header_cpp.h"
    ...
    */
      ...
      QFileSystemWatcher_Wrapper::QFileSystemWatcher_Wrapper(RJSApi& h, QFileSystemWatcher* o, bool wrappedCreated) : RJSWrapperObj(h), 
  ...
  // convert js parameter to cpp: parent (QObject)
   ...
   && a2.isUndefined()
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              QFileSystemWatcher_Wrapper::eventFilter
              (
