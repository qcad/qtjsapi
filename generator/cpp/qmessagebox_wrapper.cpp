...
int a3_cpp;
  ...
  a5
   ...
   && is_QMessageBox_StandardButtons(handler, a4
    , true
  
  )

   && is_QMessageBox_StandardButton(handler, a5
    , true
...
QMessageBox::StandardButtons a4_cpp;
          ...
          if (a4.isUndefined()) {
            ...
            a4_cpp = js2cpp_QMessageBox_StandardButtons(handler, a4);
          }
...
QMessageBox::StandardButton a5_cpp;
          ...
          if (a5.isUndefined()) {
            ...
            a5_cpp = js2cpp_QMessageBox_StandardButton(handler, a5);
          }
    ...
    , a5_cpp
            ...
            return cpp2js_QMessageBox_StandardButton(
              handler, 
              // non-copyable: false
                  res
   ...
   && is_QMessageBox_StandardButton(handler, a4
  )
...
QMessageBox::StandardButton a4_cpp;
      ...
      a4_cpp = js2cpp_QMessageBox_StandardButton(handler, a4);
...
QMessageBox_Wrapper::QMessageBox_Wrapper
  ...
  a6
      ...
      // check parameter types:
      if (
        is_QMessageBox_Icon(handler, a1
  )
   ...
   && is_QWidget_ptr(handler, a5
    , true
  
  )

   && is_Qt_WindowFlags(handler, a6
    , true
...
QMessageBox::Icon a1_cpp;
      ...
      a1_cpp = js2cpp_QMessageBox_Icon(handler, a1);
  ...
  // convert js parameter to cpp: parent (QWidget)
         ...
         a5_cpp;
          ...
          if (a5.isUndefined()) {
            ...
            a5_cpp = js2cpp_QWidget_ptr(handler, a5);
          }
...
Qt::WindowFlags a6_cpp;
          ...
          if (a6.isUndefined()) {
            ...
            a6_cpp = js2cpp_Qt_WindowFlags(handler, a6);
          }
...
Qt::WidgetAttribute a1_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              QMessageBox_Wrapper::paintEngine
              (
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                if (wb==nullptr) {
                  qWarning() << "QMessageBox::mousePressEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QMessageBox_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QMessageBox::mouseReleaseEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QMessageBox_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QMessageBox::mouseMoveEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QMessageBox_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QMessageBox::paintEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QMessageBox_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QMessageBox::actionEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
...
int a1_cpp;
  ...
  a2
      ...
      // check parameter types:
      if (
        is_QAbstractButton_ptr(handler, a1
    , true
  
  )

   && is_QMessageBox_ButtonRole(handler, a2
  )
  ...
  // convert js parameter to cpp: button (QAbstractButton)
      ...
      a1_cpp = js2cpp_QAbstractButton_ptr(handler, a1);
        
  // convert js parameter to cpp: role (QMessageBox::ButtonRole)
  
QMessageBox::ButtonRole a2_cpp;

      a2_cpp = js2cpp_QMessageBox_ButtonRole(handler, a2);
...
QMessageBox::ButtonRole a2_cpp;
    ...
    , a2_cpp
      ...
      // check parameter types:
      if (
        is_QMessageBox_StandardButton(handler, a1
  )
...
QMessageBox::StandardButton a1_cpp;
      ...
      a1_cpp = js2cpp_QMessageBox_StandardButton(handler, a1);
  ...
  // convert js parameter to cpp: member (char)
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QList_QAbstractButton_ptr(
              handler, 
              // non-copyable: false
                  res
  ...
  // convert js parameter to cpp: button (QAbstractButton)
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QMessageBox_ButtonRole(
              handler, 
              // non-copyable: false
                  res
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QMessageBox_StandardButtons(handler, a1
  )
...
QMessageBox::StandardButtons a1_cpp;
      ...
      a1_cpp = js2cpp_QMessageBox_StandardButtons(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QMessageBox_StandardButtons(
              handler, 
              // non-copyable: false
                  res
...
QMessageBox::StandardButton a1_cpp;
  ...
  // convert js parameter to cpp: button (QPushButton)
      ...
      a1_cpp = js2cpp_QPushButton_ptr(handler, a1);
...
QString a1_cpp;
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QMessageBox_Icon(
              handler, 
              // non-copyable: false
                  res
...
Qt::TextFormat a1_cpp;
      ...
      a1_cpp = js2cpp_Qt_TextFormat(handler, a1);
...
Qt::TextInteractionFlags a1_cpp;
  ...
  // convert js parameter to cpp: cb (QCheckBox)
      ...
      a1_cpp = js2cpp_QCheckBox_ptr(handler, a1);
...
Qt::WindowModality a1_cpp;
  ...
  QJSValue a1_js = cpp2js_QAbstractButton(
    handler, 
    button
  );
