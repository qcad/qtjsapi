...
int a2_cpp;
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QAbstractSpinBox_StepType(
              handler, 
              // non-copyable: false
                  res
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QAbstractSpinBox_StepType(handler, a1
  )
...
QAbstractSpinBox::StepType a1_cpp;
      ...
      a1_cpp = js2cpp_QAbstractSpinBox_StepType(handler, a1);
