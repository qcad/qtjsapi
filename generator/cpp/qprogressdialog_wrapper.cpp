...
Qt::WidgetAttribute a1_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              QProgressDialog_Wrapper::paintEngine
              (
...
int a1_cpp;
  ...
  // convert js parameter to cpp: label (QLabel)
      ...
      a1_cpp = js2cpp_QLabel_ptr(handler, a1);
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QProgressBar_ptr(handler, a1
    , true
  ...
  // convert js parameter to cpp: bar (QProgressBar)
      ...
      a1_cpp = js2cpp_QProgressBar_ptr(handler, a1);
