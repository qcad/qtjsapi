...
QTreeWidgetItem_Wrapper::QTreeWidgetItem_Wrapper
  ...
  // convert js parameter to cpp: treeview (QTreeWidget)
      ...
      a1_cpp = js2cpp_QTreeWidget_ptr(handler, a1);
...
int a3_cpp;
   ...
   && is_QTreeWidgetItem_ptr(handler, a2
    , true
  ...
  // convert js parameter to cpp: after (QTreeWidgetItem)
      ...
      a2_cpp = js2cpp_QTreeWidgetItem_ptr(handler, a2);
...
int a3_cpp;
    ...
    , a3_cpp
      ...
      // check parameter types:
      if (
        is_QTreeWidgetItem_ptr(handler, a1
    , true
  ...
  // convert js parameter to cpp: parent (QTreeWidgetItem)
      ...
      a1_cpp = js2cpp_QTreeWidgetItem_ptr(handler, a1);
...
bool a1_cpp;
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QTreeWidgetItem_ChildIndicatorPolicy(handler, a1
  )
...
QTreeWidgetItem::ChildIndicatorPolicy a1_cpp;
      ...
      a1_cpp = js2cpp_QTreeWidgetItem_ChildIndicatorPolicy(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QTreeWidgetItem_ChildIndicatorPolicy(
              handler, 
              // non-copyable: false
                  res
...
int a1_cpp;
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QList_QTreeWidgetItem_ptr(handler, a1
  )
...
QList<QTreeWidgetItem*> a1_cpp;
      ...
      a1_cpp = js2cpp_QList_QTreeWidgetItem_ptr(handler, a1);
  ...
  a2
   ...
   && is_QList_QTreeWidgetItem_ptr(handler, a2
  )
...
QList<QTreeWidgetItem*> a2_cpp;
      ...
      a2_cpp = js2cpp_QList_QTreeWidgetItem_ptr(handler, a2);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QList_QTreeWidgetItem_ptr(
              handler, 
              // non-copyable: false
                  res
...
Qt::WidgetAttribute a1_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              QTreeWidget_Wrapper::paintEngine
              (
...
QAbstractItemView::ScrollHint a2_cpp;
  ...
  QJSValue a1_js = cpp2js_QTreeWidgetItem(
    handler, 
    item
  );
  ...
  QJSValue a2_js = cpp2js_QTreeWidgetItem(
    handler, 
    previous
  );
