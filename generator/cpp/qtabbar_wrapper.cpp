...
int a3_cpp;
  ...
  // convert js parameter to cpp:  (QWidget)
    ...
    void QTabBar_Wrapper::init(RJSApi& handler) {
      ...
      QString fileName = ":generated/js/QTabBar.js";
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                if (wb==nullptr) {
                  qWarning() << "QTabBar::mousePressEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QTabBar_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QTabBar::mouseReleaseEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QTabBar_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QTabBar::actionEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
...
QTabBar::Shape a1_cpp;
      ...
      a1_cpp = js2cpp_QTabBar_Shape(handler, a1);
...
bool a1_cpp;
  ...
  a3
   ...
   && is_QTabBar_ButtonPosition(handler, a2
  )
...
QTabBar::ButtonPosition a2_cpp;
      ...
      a2_cpp = js2cpp_QTabBar_ButtonPosition(handler, a2);
...
QTabBar::ButtonPosition a2_cpp;
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QTabBar_SelectionBehavior(
              handler, 
              // non-copyable: false
                  res
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QTabBar_SelectionBehavior(handler, a1
  )
...
QTabBar::SelectionBehavior a1_cpp;
      ...
      a1_cpp = js2cpp_QTabBar_SelectionBehavior(handler, a1);
