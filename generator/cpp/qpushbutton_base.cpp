  ...
  // preceding Parameters: 2
      ...
      void QPushButton_Base::mousePressEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QPushButton_Base::mousePressEvent()";
...
event
  ...
  void QPushButton_Base::mouseReleaseEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QPushButton_Base::mouseReleaseEvent()";
...
event
  ...
  void QPushButton_Base::resizeEvent(
      QResizeEvent* event
    ) {

      //qDebug() << "QPushButton_Base::resizeEvent()";
...
event
  ...
  void QPushButton_Base::actionEvent(
      QActionEvent* event
    ) {

      //qDebug() << "QPushButton_Base::actionEvent()";
