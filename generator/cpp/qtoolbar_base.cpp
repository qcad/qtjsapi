  ...
  // preceding Parameters: 2
      ...
      void QToolBar_Base::mousePressEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QToolBar_Base::mousePressEvent()";
...
event
  ...
  void QToolBar_Base::mouseReleaseEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QToolBar_Base::mouseReleaseEvent()";
...
event
  ...
  void QToolBar_Base::actionEvent(
      QActionEvent* event
    ) {

      //qDebug() << "QToolBar_Base::actionEvent()";
