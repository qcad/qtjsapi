...
Qt::InputMethodHints a1_cpp;
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QQuickWidget_ResizeMode(
              handler, 
              // non-copyable: false
                  res
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QQuickWidget_ResizeMode(handler, a1
  )
...
QQuickWidget::ResizeMode a1_cpp;
      ...
      a1_cpp = js2cpp_QQuickWidget_ResizeMode(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QQuickWidget_Status(
              handler, 
              // non-copyable: false
                  res
...
QUrl a1_cpp;
  ...
  QJSValue a1_js = cpp2js_QQuickWidget_Status(
    handler, 
    a1
  );
