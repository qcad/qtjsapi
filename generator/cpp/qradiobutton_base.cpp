  ...
  // preceding Parameters: 2
      ...
      void QRadioButton_Base::mousePressEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QRadioButton_Base::mousePressEvent()";
...
event
  ...
  void QRadioButton_Base::mouseReleaseEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QRadioButton_Base::mouseReleaseEvent()";
...
event
  ...
  void QRadioButton_Base::resizeEvent(
      QResizeEvent* event
    ) {

      //qDebug() << "QRadioButton_Base::resizeEvent()";
...
event
  ...
  void QRadioButton_Base::actionEvent(
      QActionEvent* event
    ) {

      //qDebug() << "QRadioButton_Base::actionEvent()";
