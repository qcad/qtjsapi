  ...
  #include "RJSWrapperObj.h"
    ...
    #include "RJSType.h"
      ...
      class QPlainTextEdit_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
  ...
  a2
    ...
    class QPlainTextEdit_Wrapper : public RJSWrapperObj {
  ...
  Q_PROPERTY(
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static QPlainTextEdit* castToBase(void* vp, /*RJSType::WrappedType*/ int t) {
          switch (t) {
