...
int a3_cpp;
  ...
  // convert js parameter to cpp:  (QWidget)
    ...
    void QDialog_Wrapper::init(RJSApi& handler) {
      ...
      QString fileName = ":generated/js/QDialog.js";
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                if (wb==nullptr) {
                  qWarning() << "QDialog::mousePressEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QDialog_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QDialog::mouseReleaseEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QDialog_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QDialog::mouseMoveEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QDialog_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QDialog::paintEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QDialog_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QDialog::actionEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
