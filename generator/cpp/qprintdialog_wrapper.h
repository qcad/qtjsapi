  ...
  #ifndef QPRINTDIALOG_H_WRAPPER
  #define QPRINTDIALOG_H_WRAPPER
  ...
  #include "RJSWrapperObj.h"
    ...
    #include "RJSType.h"
      ...
      // wrapped object is QPrintDialog_Base class if new object is created: 
      ...
      public:
      //Q_INVOKABLE 
      QPrintDialog_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
  ...
  a2
    ...
    // preceding Parameters: -1
      ...
      private:
          RJSApi& handler;
          //static QPrintDialog_WrapperSingleton* _singleInstance;
  ...
  Q_PROPERTY(
    ...
    private:
      ...
      QPrintDialog_Wrapper(const QPrintDialog_Wrapper&);

    public:
      // initialization of QPrintDialog:
      static void init(RJSApi& handler);

      
        static QPrintDialog* castToBase(void* vp, /*RJSType::WrappedType*/ int t) {
          switch (t) {
        ...
        static QPrintDialog* getWrappedBase(RJSWrapper* wrapper) {
          RJSType::WrappedType t = (RJSType::WrappedType)wrapper->getWrappedType();
          void* vp = wrapper->getWrappedVoid();
          if (vp==nullptr) {
              //qWarning() << "getWrapped_QPrintDialog*: wrapper wraps NULL";
          }

          QPrintDialog* ret = castToBase(vp, t);
          if (ret==nullptr && vp!=nullptr) {
              qWarning() << "QPrintDialog*_Wrapper::getWrappedBase: extracted type " << t << "from wrapper is NULL";
          }
          return ret;
        }
  ...
  enum DialogCode {
    Rejected = QPrintDialog::Rejected,
...
PrintCurrentPage = QPrintDialog::PrintCurrentPage,
  ...
  Q_ENUM(PrintDialogOption)
    ...
    // special constructor used as prototype:
          ...
          Q_INVOKABLE 
          QPrintDialog_Wrapper(QJSEngine* e);
    ...
    */
      ...
      // special constructor to wrap existing object:
            ...
            //Q_INVOKABLE 
            QPrintDialog_Wrapper(RJSApi& h, QPrintDialog* o, bool wrappedCreated);
          

      // destructor:
      
          virtual ~QPrintDialog_Wrapper();
  ...
  // protected overwritten functions / events and their public invokable counterparts:
        ...
        virtual void* getWrappedVoid() {
          ...
          QPrintDialog_Base* getWrappedBase() {
            QPrintDialog* w = getWrapped();
            return dynamic_cast<QPrintDialog_Base*>(w);
          }

          QPrintDialog_Base* getWrappedBase() const {
            QPrintDialog* w = getWrapped();
            return dynamic_cast<QPrintDialog_Base*>(w);
          }
    ...
    Q_DECLARE_METATYPE(QPrintDialog_Wrapper*)
