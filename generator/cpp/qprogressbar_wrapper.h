  ...
  #include "RJSWrapperObj.h"
    ...
    #include "RJSType.h"
      ...
      class QProgressBar_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
  ...
  a2
    ...
    class QProgressBar_Wrapper : public RJSWrapperObj {
  ...
  Q_PROPERTY(
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static QProgressBar* castToBase(void* vp, /*RJSType::WrappedType*/ int t) {
          switch (t) {
...
BottomToTop = QProgressBar::BottomToTop,
  ...
  // protected overwritten functions / events and their public invokable counterparts:
        ...
        virtual /*RJSType::WrappedType*/ int getWrappedType() const {
              ...
              return RJSType::QProgressBar_Type;
