    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                if (wb==nullptr) {
                  qWarning() << "QTreeView::actionEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QTreeView_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QTreeView::setViewportMargins: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
...
QMargins a1_cpp;
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QTreeView_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QTreeView::viewportMargins: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QTreeView_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QTreeView::eventFilter: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
  ...
  // convert js parameter to cpp:  (QEvent)
      ...
      a1_cpp = js2cpp_QEvent_ptr(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QTreeView_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QTreeView::event: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QTreeView_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QTreeView::wheelEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QTreeView_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QTreeView::dragEnterEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
...
QModelIndex a1_cpp;
    ...
    // preceding Parameters: -1
              ...
              // signal emitter: called when signal is emitted from wrapped object:
              void 
              QTreeView_Wrapper::pressedEmitter(
  ...
  QJSValue a1_js = cpp2js_QModelIndex(
    ...
    // preceding Parameters: -1
              ...
              // signal emitter: called when signal is emitted from wrapped object:
              void 
              QTreeView_Wrapper::clickedEmitter(
                const QModelIndex& index
              ) {
                // convert cpp parameters to js:
  ...
  QJSValue a1_js = cpp2js_QModelIndex(
    ...
    // preceding Parameters: -1
              ...
              // signal emitter: called when signal is emitted from wrapped object:
              void 
              QTreeView_Wrapper::activatedEmitter(
                const QModelIndex& index
              ) {
                // convert cpp parameters to js:
  ...
  QJSValue a1_js = cpp2js_QModelIndex(
    ...
    // preceding Parameters: -1
              ...
              // signal emitter: called when signal is emitted from wrapped object:
              void 
              QTreeView_Wrapper::enteredEmitter(
                const QModelIndex& index
              ) {
                // convert cpp parameters to js:
  ...
  QJSValue a1_js = cpp2js_QModelIndex(
    ...
    // preceding Parameters: -1
              ...
              // signal emitter: called when signal is emitted from wrapped object:
              void 
              QTreeView_Wrapper::viewportEnteredEmitter(
    ...
    // preceding Parameters: -1
              ...
              // signal emitter: called when signal is emitted from wrapped object:
              void 
              QTreeView_Wrapper::iconSizeChangedEmitter(
                const QSize& size
              ) {
                // convert cpp parameters to js:
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QTreeView_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QTreeView::resizeEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
...
QModelIndex a1_cpp;
  ...
  // convert js parameter to cpp: header (QHeaderView)
      ...
      a1_cpp = js2cpp_QHeaderView_ptr(handler, a1);
...
QModelIndex a1_cpp;
  ...
  a2
   ...
   && is_QAbstractItemView_ScrollHint(handler, a2
    , true
...
QAbstractItemView::ScrollHint a2_cpp;
          ...
          if (a2.isUndefined()) {
            ...
            a2_cpp = js2cpp_QAbstractItemView_ScrollHint(handler, a2);
          }
...
QList<int> a3_cpp;
          ...
          if (a3.isUndefined()) {
            ...
            a3_cpp = js2cpp_QList_int(handler, a3);
          }
