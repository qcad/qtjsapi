  ...
  // preceding Parameters: -1
      ...
      void QTabWidget_Base::mousePressEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QTabWidget_Base::mousePressEvent()";
...
event
  ...
  void QTabWidget_Base::mouseReleaseEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QTabWidget_Base::mouseReleaseEvent()";
...
event
  ...
  void QTabWidget_Base::mouseMoveEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QTabWidget_Base::mouseMoveEvent()";
...
event
  ...
  void QTabWidget_Base::actionEvent(
      QActionEvent* event
    ) {

      //qDebug() << "QTabWidget_Base::actionEvent()";
