  ...
  // preceding Parameters: -1
      ...
      void QMdiArea_Base::actionEvent(
      QActionEvent* event
    ) {

      //qDebug() << "QMdiArea_Base::actionEvent()";
...
event
  ...
  void QMdiArea_Base::setViewportMargins(
      int left, int top, int right, int bottom
    ) {

      //qDebug() << "QMdiArea_Base::setViewportMargins()";
...
margins
  ...
  QMargins QMdiArea_Base::viewportMargins(
      
    ) {

      //qDebug() << "QMdiArea_Base::viewportMargins()";
  ...
  bool QMdiArea_Base::eventFilter(
      QObject* a1, QEvent* a2
    ) {

      //qDebug() << "QMdiArea_Base::eventFilter()";
...
a2
  ...
  bool QMdiArea_Base::event(
      QEvent* a1
    ) {

      //qDebug() << "QMdiArea_Base::event()";
...
a1
  ...
  bool QMdiArea_Base::viewportEvent(
      QEvent* a1
    ) {

      //qDebug() << "QMdiArea_Base::viewportEvent()";
...
a1
  ...
  void QMdiArea_Base::resizeEvent(
      QResizeEvent* a1
    ) {

      //qDebug() << "QMdiArea_Base::resizeEvent()";
...
a1
  ...
  void QMdiArea_Base::paintEvent(
      QPaintEvent* a1
    ) {

      //qDebug() << "QMdiArea_Base::paintEvent()";
...
a1
  ...
  void QMdiArea_Base::mousePressEvent(
      QMouseEvent* a1
    ) {

      //qDebug() << "QMdiArea_Base::mousePressEvent()";
...
a1
  ...
  void QMdiArea_Base::mouseReleaseEvent(
      QMouseEvent* a1
    ) {

      //qDebug() << "QMdiArea_Base::mouseReleaseEvent()";
...
a1
  ...
  void QMdiArea_Base::mouseDoubleClickEvent(
      QMouseEvent* a1
    ) {

      //qDebug() << "QMdiArea_Base::mouseDoubleClickEvent()";
...
a1
  ...
  void QMdiArea_Base::mouseMoveEvent(
      QMouseEvent* a1
    ) {

      //qDebug() << "QMdiArea_Base::mouseMoveEvent()";
...
a1
  ...
  void QMdiArea_Base::wheelEvent(
      QWheelEvent* a1
    ) {

      //qDebug() << "QMdiArea_Base::wheelEvent()";
...
a1
  ...
  void QMdiArea_Base::dragEnterEvent(
      QDragEnterEvent* a1
    ) {

      //qDebug() << "QMdiArea_Base::dragEnterEvent()";
...
a1
  ...
  void QMdiArea_Base::keyPressEvent(
      QKeyEvent* a1
    ) {

      //qDebug() << "QMdiArea_Base::keyPressEvent()";
...
a1
  ...
  QSize QMdiArea_Base::viewportSizeHint(
      
    ) {

      //qDebug() << "QMdiArea_Base::viewportSizeHint()";
