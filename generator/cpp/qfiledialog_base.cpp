  ...
  // preceding Parameters: 4
      ...
      void QFileDialog_Base::mousePressEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QFileDialog_Base::mousePressEvent()";
...
event
  ...
  void QFileDialog_Base::mouseReleaseEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QFileDialog_Base::mouseReleaseEvent()";
...
event
  ...
  void QFileDialog_Base::mouseMoveEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QFileDialog_Base::mouseMoveEvent()";
...
event
  ...
  void QFileDialog_Base::paintEvent(
      QPaintEvent* event
    ) {

      //qDebug() << "QFileDialog_Base::paintEvent()";
...
event
  ...
  void QFileDialog_Base::actionEvent(
      QActionEvent* event
    ) {

      //qDebug() << "QFileDialog_Base::actionEvent()";
...
event
  ...
  void QFileDialog_Base::resizeEvent(
      QResizeEvent* a1
    ) {

      //qDebug() << "QFileDialog_Base::resizeEvent()";
