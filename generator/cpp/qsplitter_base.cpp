  ...
  // preceding Parameters: 2
      ...
      void QSplitter_Base::mousePressEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QSplitter_Base::mousePressEvent()";
...
event
  ...
  void QSplitter_Base::mouseReleaseEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QSplitter_Base::mouseReleaseEvent()";
...
event
  ...
  void QSplitter_Base::actionEvent(
      QActionEvent* event
    ) {

      //qDebug() << "QSplitter_Base::actionEvent()";
...
event
  ...
  void QSplitter_Base::paintEvent(
      QPaintEvent* event
    ) {

      //qDebug() << "QSplitter_Base::paintEvent()";
...
event
  ...
  void QSplitter_Base::mouseMoveEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QSplitter_Base::mouseMoveEvent()";
...
a1
  ...
  // preceding Parameters: -1
      ...
      // protected overwritten functions / events and their public invokable counterparts:
      void QSplitterHandle_Base::actionEvent(
      QActionEvent* event
    ) {

      //qDebug() << "QSplitterHandle_Base::actionEvent()";
