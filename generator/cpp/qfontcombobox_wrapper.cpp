...
int a3_cpp;
  ...
  // convert js parameter to cpp:  (QWidget)
    ...
    void QFontComboBox_Wrapper::init(RJSApi& handler) {
      ...
      QString fileName = ":generated/js/QFontComboBox.js";
...
Qt::WidgetAttribute a1_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              QFontComboBox_Wrapper::paintEngine
              (
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                // call function of QFontComboBox_Base class as 
                // function has postfix inheritable class, overridable function):
                QFontComboBox_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QFontComboBox::mouseMoveEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QFontComboBox_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QFontComboBox::actionEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
...
Qt::MatchFlags a3_cpp;
          ...
          if (a3.isUndefined()) {
            ...
            a3_cpp = js2cpp_Qt_MatchFlags(handler, a3);
          }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QComboBox_InsertPolicy(
              handler, 
              // non-copyable: false
                  res
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QComboBox_InsertPolicy(handler, a1
  )
...
QComboBox::InsertPolicy a1_cpp;
      ...
      a1_cpp = js2cpp_QComboBox_InsertPolicy(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QComboBox_SizeAdjustPolicy(
              handler, 
              // non-copyable: false
                  res
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QComboBox_SizeAdjustPolicy(handler, a1
  )
...
QComboBox::SizeAdjustPolicy a1_cpp;
      ...
      a1_cpp = js2cpp_QComboBox_SizeAdjustPolicy(handler, a1);
...
bool a1_cpp;
  ...
  // convert js parameter to cpp: edit (QLineEdit)
      ...
      a1_cpp = js2cpp_QLineEdit_ptr(handler, a1);
  ...
  // convert js parameter to cpp: v (QValidator)
      ...
      a1_cpp = js2cpp_QValidator_ptr(handler, a1);
  ...
  // convert js parameter to cpp: c (QCompleter)
      ...
      a1_cpp = js2cpp_QCompleter_ptr(handler, a1);
...
QVariant a4_cpp;
          ...
          if (a4.isUndefined()) {
            ...
            a4_cpp = js2cpp_QVariant(handler, a4);
          }
...
QString a1_cpp;
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QFontComboBox_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QFontComboBox::resizeEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QFontComboBox_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QFontComboBox::paintEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QFontDatabase_WritingSystem(handler, a1
  )
...
QFontDatabase::WritingSystem a1_cpp;
      ...
      a1_cpp = js2cpp_QFontDatabase_WritingSystem(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QFontDatabase_WritingSystem(
              handler, 
              // non-copyable: false
                  res
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QFontComboBox_FontFilters(handler, a1
  )
...
QFontComboBox::FontFilters a1_cpp;
      ...
      a1_cpp = js2cpp_QFontComboBox_FontFilters(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QFontComboBox_FontFilters(
              handler, 
              // non-copyable: false
                  res
