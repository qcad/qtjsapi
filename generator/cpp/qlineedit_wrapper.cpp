    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                if (wb==nullptr) {
                  qWarning() << "QLineEdit::resizeEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QLineEdit_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QLineEdit::actionEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
...
bool a1_cpp;
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QLineEdit_EchoMode(
              handler, 
              // non-copyable: false
                  res
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QLineEdit_EchoMode(handler, a1
  )
...
QLineEdit::EchoMode a1_cpp;
      ...
      a1_cpp = js2cpp_QLineEdit_EchoMode(handler, a1);
...
QMargins a1_cpp;
  ...
  a2
   ...
   && is_QLineEdit_ActionPosition(handler, a2
  )
...
QLineEdit::ActionPosition a2_cpp;
      ...
      a2_cpp = js2cpp_QLineEdit_ActionPosition(handler, a2);
