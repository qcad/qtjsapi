...
int a3_cpp;
  ...
  // convert js parameter to cpp:  (QWidget)
    ...
    void QAbstractSlider_Wrapper::init(RJSApi& handler) {
      ...
      QString fileName = ":generated/js/QAbstractSlider.js";
...
Qt::WidgetAttribute a1_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              QAbstractSlider_Wrapper::paintEngine
              (
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                // call function of QAbstractSlider_Base class as 
                // function has postfix inheritable class, overridable function):
                QAbstractSlider_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QAbstractSlider::mousePressEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QAbstractSlider_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QAbstractSlider::mouseReleaseEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QAbstractSlider_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QAbstractSlider::mouseMoveEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QAbstractSlider_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QAbstractSlider::paintEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QAbstractSlider_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QAbstractSlider::resizeEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QAbstractSlider_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QAbstractSlider::actionEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
...
bool a1_cpp;
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QAbstractSlider_SliderAction(handler, a1
  )
...
QAbstractSlider::SliderAction a1_cpp;
      ...
      a1_cpp = js2cpp_QAbstractSlider_SliderAction(handler, a1);
