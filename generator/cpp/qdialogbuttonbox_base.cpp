  ...
  // preceding Parameters: 2
      ...
      void QDialogButtonBox_Base::mousePressEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QDialogButtonBox_Base::mousePressEvent()";
...
event
  ...
  void QDialogButtonBox_Base::mouseReleaseEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QDialogButtonBox_Base::mouseReleaseEvent()";
...
event
  ...
  void QDialogButtonBox_Base::mouseMoveEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QDialogButtonBox_Base::mouseMoveEvent()";
...
event
  ...
  void QDialogButtonBox_Base::paintEvent(
      QPaintEvent* event
    ) {

      //qDebug() << "QDialogButtonBox_Base::paintEvent()";
...
event
  ...
  void QDialogButtonBox_Base::resizeEvent(
      QResizeEvent* event
    ) {

      //qDebug() << "QDialogButtonBox_Base::resizeEvent()";
...
event
  ...
  void QDialogButtonBox_Base::actionEvent(
      QActionEvent* event
    ) {

      //qDebug() << "QDialogButtonBox_Base::actionEvent()";
