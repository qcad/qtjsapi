  ...
  // preceding Parameters: 3
      ...
      void QDockWidget_Base::mousePressEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QDockWidget_Base::mousePressEvent()";
...
event
  ...
  void QDockWidget_Base::mouseReleaseEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QDockWidget_Base::mouseReleaseEvent()";
...
event
  ...
  void QDockWidget_Base::actionEvent(
      QActionEvent* event
    ) {

      //qDebug() << "QDockWidget_Base::actionEvent()";
