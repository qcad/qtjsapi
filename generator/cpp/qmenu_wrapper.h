  ...
  #include "RJSWrapperObj.h"
    ...
    #include "RJSType.h"
      ...
      class QMenu_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
  ...
  a4
    ...
    class QMenu_Wrapper : public RJSWrapperObj {
  ...
  Q_PROPERTY(
    ...
    public:
      ...
      static void init(RJSApi& handler);
        ...
        static QMenu* castToBase(void* vp, /*RJSType::WrappedType*/ int t) {
          switch (t) {
