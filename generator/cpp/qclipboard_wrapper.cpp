...
int a3_cpp;
    ...
    void QClipboard_Wrapper::init(RJSApi& handler) {
      ...
      QString fileName = ":generated/js/QClipboard.js";
...
QClipboard::Mode a1_cpp;
          ...
          if (a1.isUndefined()) {
            ...
            a1_cpp = js2cpp_QClipboard_Mode(handler, a1);
          }
...
QClipboard::Mode a2_cpp;
          ...
          if (a2.isUndefined()) {
            ...
            a2_cpp = js2cpp_QClipboard_Mode(handler, a2);
          }
...
QClipboard::Mode a2_cpp;
  ...
  QJSValue a1_js = cpp2js_QClipboard_Mode(
    handler, 
    mode
  );
