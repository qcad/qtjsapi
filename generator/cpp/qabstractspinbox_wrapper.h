  ...
  // Auto generated
    ...
    #ifndef QABSTRACTSPINBOX_H_WRAPPER
    #define QABSTRACTSPINBOX_H_WRAPPER
    ...
    // wrapper class for QAbstractSpinBox
    class QTJSAPI_EXPORT QAbstractSpinBox_Wrapper : public RJSWrapperObj {
  ...
  Q_PROPERTY(
    ...
    private:
      ...
      QAbstractSpinBox_Wrapper(const QAbstractSpinBox_Wrapper&);

    public:
      // initialization of QAbstractSpinBox:
      static void init(RJSApi& handler);

      
        static QAbstractSpinBox* castToBase(void* vp, /*RJSType ID*/ int t) {
          
            // check if pointer points to derrived type:
            
              if (t==RJSType_QSpinBox::getIdStatic()) {
                return (QAbstractSpinBox*)(QSpinBox*)vp;
              }
              
              if (t==RJSType_QDoubleSpinBox::getIdStatic()) {
                return (QAbstractSpinBox*)(QDoubleSpinBox*)vp;
              }
              

          // hook for modules to cast from other types to base QAbstractSpinBox:
          for (int i=0; i<basecasters_QAbstractSpinBox.length(); i++) {
            RJSBasecaster_QAbstractSpinBox* basecaster = basecasters_QAbstractSpinBox[i];
            QAbstractSpinBox* ret = basecaster->castToBase(t, vp);
            if (ret!=nullptr) {
              return ret;
            }
          }

          // object is a pointer to base class QAbstractSpinBox:
          if (t==RJSType_QAbstractSpinBox::getIdStatic()) {
            return (QAbstractSpinBox*)vp;
          }

          qWarning() << "QAbstractSpinBox_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);

          return nullptr;
          
        }

        static QAbstractSpinBox* getWrappedBase(RJSWrapper* wrapper) {
          int t = wrapper->getWrappedType();
          void* vp = wrapper->getWrappedVoid();
          if (vp==nullptr) {
              //qWarning() << "getWrapped_QAbstractSpinBox*: wrapper wraps NULL";
          }

          QAbstractSpinBox* ret = castToBase(vp, t);
          if (ret==nullptr && vp!=nullptr) {
              qWarning() << "QAbstractSpinBox*_Wrapper::getWrappedBase: extracted type " << t << "from wrapper is NULL";
          }
          return ret;
        }
    ...
    // special constructor used as prototype:
          ...
          Q_INVOKABLE 
          QAbstractSpinBox_Wrapper(QJSEngine* e);
    ...
    */
      ...
      // special constructor to wrap existing object:
            ...
            //Q_INVOKABLE 
            QAbstractSpinBox_Wrapper(RJSApi& h, QAbstractSpinBox* o, bool wrappedCreated);
          

      // destructor:
      
          virtual ~QAbstractSpinBox_Wrapper();
  ...
  // protected overwritten functions / events and their public invokable counterparts:
        ...
        QAbstractSpinBox* getWrapped() const {
      ...
      private:
        ...
        static QList<RJSBasecaster_QAbstractSpinBox*> basecasters_QAbstractSpinBox;

      public:
        static void registerBasecaster_QAbstractSpinBox(RJSBasecaster_QAbstractSpinBox* bc) {
          basecasters_QAbstractSpinBox.append(bc);
        }
      
    };

    Q_DECLARE_METATYPE(QAbstractSpinBox_Wrapper*)

    Q_DECLARE_INTERFACE(QAbstractSpinBox_Wrapper, "org.qcad.QAbstractSpinBox_Wrapper")
