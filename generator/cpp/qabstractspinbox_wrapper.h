  ...
  // Auto generated
    ...
    #include <QQmlEngine>
      ...
      class QTJSAPI_EXPORT QAbstractSpinBox_WrapperSingleton: public QObject {
      Q_OBJECT
      QML_INTERFACE
      ...
      public:
      //Q_INVOKABLE 
      QAbstractSpinBox_WrapperSingleton(RJSApi& h) 
        : QObject(), 
          handler(h)
  ...
  a2
    ...
    // preceding Parameters: -1
      ...
      private:
          RJSApi& handler;
          //static QAbstractSpinBox_WrapperSingleton* _singleInstance;
