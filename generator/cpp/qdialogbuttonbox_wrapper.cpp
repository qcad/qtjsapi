...
int a3_cpp;
  ...
  // convert js parameter to cpp:  (QWidget)
    ...
    void QDialogButtonBox_Wrapper::init(RJSApi& handler) {
      ...
      QString fileName = ":generated/js/QDialogButtonBox.js";
...
QDialogButtonBox_Wrapper::QDialogButtonBox_Wrapper
  ...
  a3
      ...
      // check parameter types:
      if (
        is_QDialogButtonBox_StandardButtons(handler, a1
  )
...
QDialogButtonBox::StandardButtons a1_cpp;
      ...
      a1_cpp = js2cpp_QDialogButtonBox_StandardButtons(handler, a1);
...
Qt::WidgetAttribute a1_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              QDialogButtonBox_Wrapper::paintEngine
              (
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                // call function of QDialogButtonBox_Base class as 
                // function has postfix inheritable class, overridable function):
                QDialogButtonBox_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QDialogButtonBox::mousePressEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QDialogButtonBox_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QDialogButtonBox::mouseReleaseEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QDialogButtonBox_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QDialogButtonBox::mouseMoveEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QDialogButtonBox_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QDialogButtonBox::paintEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QDialogButtonBox_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QDialogButtonBox::resizeEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QDialogButtonBox_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QDialogButtonBox::actionEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
...
Qt::Orientation a1_cpp;
  ...
  a2
   ...
   && is_QDialogButtonBox_ButtonRole(handler, a2
  )
...
QDialogButtonBox::ButtonRole a2_cpp;
      ...
      a2_cpp = js2cpp_QDialogButtonBox_ButtonRole(handler, a2);
...
QDialogButtonBox::ButtonRole a2_cpp;
    ...
    , a2_cpp
      ...
      // check parameter types:
      if (
        is_QDialogButtonBox_StandardButton(handler, a1
  )
...
QDialogButtonBox::StandardButton a1_cpp;
      ...
      a1_cpp = js2cpp_QDialogButtonBox_StandardButton(handler, a1);
  ...
  // convert js parameter to cpp: button (QAbstractButton)
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QDialogButtonBox_ButtonRole(
              handler, 
              // non-copyable: false
                  res
...
QDialogButtonBox::StandardButtons a1_cpp;
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QDialogButtonBox_StandardButtons(
              handler, 
              // non-copyable: false
                  res
  ...
  // convert js parameter to cpp: button (QAbstractButton)
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QDialogButtonBox_StandardButton(
              handler, 
              // non-copyable: false
                  res
