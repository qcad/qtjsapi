  ...
  // preceding Parameters: 2
      ...
      void QPrintDialog_Base::mousePressEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QPrintDialog_Base::mousePressEvent()";
...
event
  ...
  void QPrintDialog_Base::mouseReleaseEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QPrintDialog_Base::mouseReleaseEvent()";
...
event
  ...
  void QPrintDialog_Base::mouseMoveEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QPrintDialog_Base::mouseMoveEvent()";
...
event
  ...
  void QPrintDialog_Base::paintEvent(
      QPaintEvent* event
    ) {

      //qDebug() << "QPrintDialog_Base::paintEvent()";
...
event
  ...
  void QPrintDialog_Base::actionEvent(
      QActionEvent* event
    ) {

      //qDebug() << "QPrintDialog_Base::actionEvent()";
...
event
  ...
  void QPrintDialog_Base::resizeEvent(
      QResizeEvent* a1
    ) {

      //qDebug() << "QPrintDialog_Base::resizeEvent()";
