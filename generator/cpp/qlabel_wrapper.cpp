...
int a3_cpp;
  ...
  // convert js parameter to cpp:  (QWidget)
    ...
    void QLabel_Wrapper::init(RJSApi& handler) {
      ...
      QString fileName = ":generated/js/QLabel.js";
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                if (wb==nullptr) {
                  qWarning() << "QLabel::actionEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
...
QRect a1_cpp;
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QLabel_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QLabel::resizeEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
  ...
  a1
      ...
      // check parameter types:
      if (
        is_Qt_ReturnByValueConstant(handler, a1
  )
...
Qt::ReturnByValueConstant a1_cpp;
      ...
      a1_cpp = js2cpp_Qt_ReturnByValueConstant(handler, a1);
