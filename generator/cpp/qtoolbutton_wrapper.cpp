...
Qt::WidgetAttribute a1_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              QToolButton_Wrapper::paintEngine
              (
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                // call function of QToolButton_Base class as 
                // function has postfix inheritable class, overridable function):
                QToolButton_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QToolButton::mousePressEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QToolButton_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QToolButton::mouseReleaseEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QToolButton_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QToolButton::mouseMoveEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QToolButton_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QToolButton::paintEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QToolButton_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QToolButton::resizeEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QToolButton_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QToolButton::actionEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
...
Qt::ArrowType a1_cpp;
      ...
      a1_cpp = js2cpp_Qt_ArrowType(handler, a1);
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QToolButton_ToolButtonPopupMode(handler, a1
  )
...
QToolButton::ToolButtonPopupMode a1_cpp;
      ...
      a1_cpp = js2cpp_QToolButton_ToolButtonPopupMode(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QToolButton_ToolButtonPopupMode(
              handler, 
              // non-copyable: false
                  res
