...
int a3_cpp;
  ...
  // convert js parameter to cpp:  (QWidget)
    ...
    void QProgressBar_Wrapper::init(RJSApi& handler) {
      ...
      QString fileName = ":generated/js/QProgressBar.js";
...
Qt::WidgetAttribute a1_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              QProgressBar_Wrapper::paintEngine
              (
...
bool a1_cpp;
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QProgressBar_Direction(handler, a1
  )
...
QProgressBar::Direction a1_cpp;
      ...
      a1_cpp = js2cpp_QProgressBar_Direction(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QProgressBar_Direction(
              handler, 
              // non-copyable: false
                  res
