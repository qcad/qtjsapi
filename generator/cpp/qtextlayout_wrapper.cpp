  ...
  //#include "header_cpp.h"
    ...
    void QTextLayout_Wrapper::init(RJSApi& handler) {
      ...
      QString fileName = ":generated/js/QTextLayout.js";
...
QTextLayout_Wrapper::QTextLayout_Wrapper
  ...
  a3
   ...
   && is_QPaintDevice_ptr(handler, a3
    , true
  ...
  // convert js parameter to cpp: paintdevice (QPaintDevice)
         ...
         a3_cpp;
          ...
          if (a3.isUndefined()) {
            ...
            a3_cpp = js2cpp_QPaintDevice_ptr(handler, a3);
          }
...
int a1_cpp;
  ...
  a2
   ...
   && is_QTextLayout_CursorMode(handler, a2
    , true
...
QTextLayout::CursorMode a2_cpp;
          ...
          if (a2.isUndefined()) {
            ...
            a2_cpp = js2cpp_QTextLayout_CursorMode(handler, a2);
          }
