...
int a3_cpp;
  ...
  // convert js parameter to cpp:  (QWidget)
    ...
    void QListView_Wrapper::init(RJSApi& handler) {
      ...
      QString fileName = ":generated/js/QListView.js";
...
int a3_cpp;
  ...
  // convert js parameter to cpp: e (QDropEvent)
      ...
      a1_cpp = js2cpp_QDropEvent_ptr(handler, a1);
...
Qt::DropActions a1_cpp;
      ...
      a1_cpp = js2cpp_Qt_DropActions(handler, a1);
