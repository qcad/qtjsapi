  ...
  // preceding Parameters: -1
      ...
      void QDialog_Base::mousePressEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QDialog_Base::mousePressEvent()";
...
event
  ...
  void QDialog_Base::mouseReleaseEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QDialog_Base::mouseReleaseEvent()";
...
event
  ...
  void QDialog_Base::mouseMoveEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QDialog_Base::mouseMoveEvent()";
...
event
  ...
  void QDialog_Base::paintEvent(
      QPaintEvent* event
    ) {

      //qDebug() << "QDialog_Base::paintEvent()";
...
event
  ...
  void QDialog_Base::actionEvent(
      QActionEvent* event
    ) {

      //qDebug() << "QDialog_Base::actionEvent()";
