  ...
  //#include "header_cpp.h"
    ...
    */
      ...
      QStackedWidget_Wrapper::QStackedWidget_Wrapper(RJSApi& h, QStackedWidget* o, bool wrappedCreated) : RJSWrapperObj(h), 
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                if (wb==nullptr) {
                  qWarning() << "QStackedWidget::eventFilter: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
