...
int a3_cpp;
  ...
  // convert js parameter to cpp:  (QWidget)
    ...
    void QSplashScreen_Wrapper::init(RJSApi& handler) {
      ...
      QString fileName = ":generated/js/QSplashScreen.js";
...
Qt::WidgetAttribute a1_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              QSplashScreen_Wrapper::paintEngine
              (
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                // call function of QSplashScreen_Base class as 
                // function has postfix inheritable class, overridable function):
                QSplashScreen_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QSplashScreen::mouseReleaseEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QSplashScreen_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QSplashScreen::mouseMoveEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QSplashScreen_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QSplashScreen::paintEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QSplashScreen_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QSplashScreen::resizeEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QSplashScreen_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QSplashScreen::actionEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
