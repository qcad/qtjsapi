...
int a3_cpp;
  ...
  // convert js parameter to cpp:  (QWidget)
    ...
    void QScrollBar_Wrapper::init(RJSApi& handler) {
      ...
      QString fileName = ":generated/js/QScrollBar.js";
...
Qt::WidgetAttribute a1_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              QScrollBar_Wrapper::paintEngine
              (
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                if (wb==nullptr) {
                  qWarning() << "QScrollBar::resizeEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QScrollBar_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QScrollBar::actionEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
