  ...
  // preceding Parameters: 2
      ...
      bool QQuickWidget_Base::eventFilter(
      QObject* watched, QEvent* event
    ) {

      //qDebug() << "QQuickWidget_Base::eventFilter()";
...
event
        ...
        if (res.isError()) {
          ...
          return
        QQuickWidget::eventFilter(
          watched, event
        );
      }
    }

  void QQuickWidget_Base::mousePressEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QQuickWidget_Base::mousePressEvent()";
...
event
  ...
  void QQuickWidget_Base::mouseReleaseEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QQuickWidget_Base::mouseReleaseEvent()";
...
event
  ...
  void QQuickWidget_Base::mouseMoveEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QQuickWidget_Base::mouseMoveEvent()";
...
event
  ...
  void QQuickWidget_Base::paintEvent(
      QPaintEvent* event
    ) {

      //qDebug() << "QQuickWidget_Base::paintEvent()";
...
event
  ...
  void QQuickWidget_Base::resizeEvent(
      QResizeEvent* event
    ) {

      //qDebug() << "QQuickWidget_Base::resizeEvent()";
...
event
  ...
  void QQuickWidget_Base::actionEvent(
      QActionEvent* event
    ) {

      //qDebug() << "QQuickWidget_Base::actionEvent()";
