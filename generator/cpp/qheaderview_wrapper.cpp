...
Qt::Orientation a1_cpp;
      ...
      a1_cpp = js2cpp_Qt_Orientation(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                if (wb==nullptr) {
                  qWarning() << "QHeaderView::actionEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
...
QFrame::Shape a1_cpp;
      ...
      a1_cpp = js2cpp_QFrame_Shape(handler, a1);
...
QFrame::Shadow a1_cpp;
      ...
      a1_cpp = js2cpp_QFrame_Shadow(handler, a1);
...
QRect a1_cpp;
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_Qt_ScrollBarPolicy(
              handler, 
              // non-copyable: false
                  res
  ...
  a1
      ...
      // check parameter types:
      if (
        is_Qt_ScrollBarPolicy(handler, a1
  )
...
Qt::ScrollBarPolicy a1_cpp;
      ...
      a1_cpp = js2cpp_Qt_ScrollBarPolicy(handler, a1);
  ...
  // convert js parameter to cpp: scrollbar (QScrollBar)
      ...
      a1_cpp = js2cpp_QScrollBar_ptr(handler, a1);
...
Qt::Alignment a2_cpp;
      ...
      a2_cpp = js2cpp_Qt_Alignment(handler, a2);
  ...
  // convert js parameter to cpp: viewport (QWidget)
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QAbstractScrollArea_SizeAdjustPolicy(
              handler, 
              // non-copyable: false
                  res
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QAbstractScrollArea_SizeAdjustPolicy(handler, a1
  )
...
QAbstractScrollArea::SizeAdjustPolicy a1_cpp;
      ...
      a1_cpp = js2cpp_QAbstractScrollArea_SizeAdjustPolicy(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QHeaderView_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QHeaderView::setViewportMargins: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
...
QMargins a1_cpp;
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QHeaderView_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QHeaderView::viewportMargins: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QHeaderView_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QHeaderView::eventFilter: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
  ...
  // convert js parameter to cpp:  (QWheelEvent)
      ...
      a1_cpp = js2cpp_QWheelEvent_ptr(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QHeaderView_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QHeaderView::wheelEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QDragEnterEvent_ptr(handler, a1
    , true
  ...
  // convert js parameter to cpp:  (QDragEnterEvent)
      ...
      a1_cpp = js2cpp_QDragEnterEvent_ptr(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QHeaderView_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QHeaderView::dragEnterEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
  ...
  // convert js parameter to cpp:  (QKeyEvent)
      ...
      a1_cpp = js2cpp_QKeyEvent_ptr(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QHeaderView_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QHeaderView::keyPressEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QHeaderView_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QHeaderView::viewportSizeHint: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QAbstractItemModel_ptr(handler, a1
    , true
  ...
  // convert js parameter to cpp: model (QAbstractItemModel)
      ...
      a1_cpp = js2cpp_QAbstractItemModel_ptr(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QAbstractItemModel(
              handler, 
              // non-copyable: true
                  res
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QItemSelectionModel_ptr(handler, a1
    , true
  ...
  // convert js parameter to cpp: selectionModel (QItemSelectionModel)
      ...
      a1_cpp = js2cpp_QItemSelectionModel_ptr(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QItemSelectionModel(
              handler, 
              // non-copyable: true
                  res
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QAbstractItemDelegate_ptr(handler, a1
    , true
  ...
  // convert js parameter to cpp: delegate (QAbstractItemDelegate)
      ...
      a1_cpp = js2cpp_QAbstractItemDelegate_ptr(handler, a1);
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QAbstractItemView_SelectionMode(handler, a1
  )
...
QAbstractItemView::SelectionMode a1_cpp;
      ...
      a1_cpp = js2cpp_QAbstractItemView_SelectionMode(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QAbstractItemView_SelectionMode(
              handler, 
              // non-copyable: false
                  res
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QAbstractItemView_SelectionBehavior(handler, a1
  )
...
QAbstractItemView::SelectionBehavior a1_cpp;
      ...
      a1_cpp = js2cpp_QAbstractItemView_SelectionBehavior(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QAbstractItemView_SelectionBehavior(
              handler, 
              // non-copyable: false
                  res
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QAbstractItemView_EditTriggers(handler, a1
  )
...
QAbstractItemView::EditTriggers a1_cpp;
      ...
      a1_cpp = js2cpp_QAbstractItemView_EditTriggers(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QAbstractItemView_EditTriggers(
              handler, 
              // non-copyable: false
                  res
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QAbstractItemView_ScrollMode(handler, a1
  )
...
QAbstractItemView::ScrollMode a1_cpp;
      ...
      a1_cpp = js2cpp_QAbstractItemView_ScrollMode(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QAbstractItemView_ScrollMode(
              handler, 
              // non-copyable: false
                  res
...
bool a1_cpp;
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QAbstractItemView_DragDropMode(handler, a1
  )
...
QAbstractItemView::DragDropMode a1_cpp;
      ...
      a1_cpp = js2cpp_QAbstractItemView_DragDropMode(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QAbstractItemView_DragDropMode(
              handler, 
              // non-copyable: false
                  res
...
Qt::DropAction a1_cpp;
      ...
      a1_cpp = js2cpp_Qt_DropAction(handler, a1);
...
QSize a1_cpp;
  ...
  a1
      ...
      // check parameter types:
      if (
        is_Qt_TextElideMode(handler, a1
  )
...
Qt::TextElideMode a1_cpp;
      ...
      a1_cpp = js2cpp_Qt_TextElideMode(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_Qt_TextElideMode(
              handler, 
              // non-copyable: false
                  res
...
QModelIndex a1_cpp;
    ...
    // preceding Parameters: -1
              ...
              // signal emitter: called when signal is emitted from wrapped object:
              void 
              QHeaderView_Wrapper::pressedEmitter(
  ...
  QJSValue a1_js = cpp2js_QModelIndex(
    ...
    // preceding Parameters: -1
              ...
              // signal emitter: called when signal is emitted from wrapped object:
              void 
              QHeaderView_Wrapper::clickedEmitter(
                const QModelIndex& index
              ) {
                // convert cpp parameters to js:
  ...
  QJSValue a1_js = cpp2js_QModelIndex(
    ...
    // preceding Parameters: -1
              ...
              // signal emitter: called when signal is emitted from wrapped object:
              void 
              QHeaderView_Wrapper::activatedEmitter(
                const QModelIndex& index
              ) {
                // convert cpp parameters to js:
  ...
  QJSValue a1_js = cpp2js_QModelIndex(
    ...
    // preceding Parameters: -1
              ...
              // signal emitter: called when signal is emitted from wrapped object:
              void 
              QHeaderView_Wrapper::enteredEmitter(
                const QModelIndex& index
              ) {
                // convert cpp parameters to js:
  ...
  QJSValue a1_js = cpp2js_QModelIndex(
    ...
    // preceding Parameters: -1
              ...
              // signal emitter: called when signal is emitted from wrapped object:
              void 
              QHeaderView_Wrapper::viewportEnteredEmitter(
    ...
    // preceding Parameters: -1
              ...
              // signal emitter: called when signal is emitted from wrapped object:
              void 
              QHeaderView_Wrapper::iconSizeChangedEmitter(
                const QSize& size
              ) {
                // convert cpp parameters to js:
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QHeaderView_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QHeaderView::resizeEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
...
int a1_cpp;
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QHeaderView_ResizeMode(
              handler, 
              // non-copyable: false
                  res
  ...
  a2
   ...
   && is_QHeaderView_ResizeMode(handler, a2
  )
...
QHeaderView::ResizeMode a2_cpp;
      ...
      a2_cpp = js2cpp_QHeaderView_ResizeMode(handler, a2);
    ...
    , a2_cpp
      ...
      // check parameter types:
      if (
        is_QHeaderView_ResizeMode(handler, a1
  )
...
QHeaderView::ResizeMode a1_cpp;
      ...
      a1_cpp = js2cpp_QHeaderView_ResizeMode(handler, a1);
...
int a3_cpp;
  ...
  QJSValue a2_js = cpp2js_Qt_SortOrder(
    handler, 
    order
  );
