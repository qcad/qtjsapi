...
int a3_cpp;
  ...
  // convert js parameter to cpp:  (QWidget)
    ...
    void QTableView_Wrapper::init(RJSApi& handler) {
      ...
      QString fileName = ":generated/js/QTableView.js";
...
Qt::WidgetAttribute a1_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              QTableView_Wrapper::paintEngine
              (
...
int a2_cpp;
  ...
  a2
   ...
   && is_QItemSelectionModel_SelectionFlags(handler, a2
  )
...
QItemSelectionModel::SelectionFlags a2_cpp;
      ...
      a2_cpp = js2cpp_QItemSelectionModel_SelectionFlags(handler, a2);
...
QItemSelection a1_cpp;
      ...
      a1_cpp = js2cpp_QItemSelection(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QTableView_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QTableView::sizeHintForRow: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
            ...
            return cpp2js_int(
              ...
              // non-copyable: false
                  ...
                  qWarning() << "no matching function variant found for sizeHintForRow";
                  handler.trace();
                  return QJSValue();
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QTableView_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QTableView::sizeHintForColumn: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
            ...
            return cpp2js_int(
              ...
              // non-copyable: false
                  ...
                  qWarning() << "no matching function variant found for sizeHintForColumn";
                  handler.trace();
                  return QJSValue();
...
QItemSelection a2_cpp;
      ...
      a2_cpp = js2cpp_QItemSelection(handler, a2);
