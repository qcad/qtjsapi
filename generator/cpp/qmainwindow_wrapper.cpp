    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                if (wb==nullptr) {
                  qWarning() << "QMainWindow::mousePressEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QMainWindow_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QMainWindow::mouseReleaseEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QMainWindow_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QMainWindow::mouseMoveEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QMainWindow_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QMainWindow::paintEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QMainWindow_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QMainWindow::resizeEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QMainWindow_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QMainWindow::actionEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
...
QSize a1_cpp;
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_Qt_ToolButtonStyle(
              handler, 
              // non-copyable: false
                  res
  ...
  a1
      ...
      // check parameter types:
      if (
        is_Qt_ToolButtonStyle(handler, a1
  )
...
Qt::ToolButtonStyle a1_cpp;
      ...
      a1_cpp = js2cpp_Qt_ToolButtonStyle(handler, a1);
...
QTabWidget::TabShape a1_cpp;
  ...
  a1
      ...
      // check parameter types:
      if (
        is_Qt_DockWidgetArea(handler, a1
  )
...
Qt::DockWidgetArea a1_cpp;
      ...
      a1_cpp = js2cpp_Qt_DockWidgetArea(handler, a1);
  ...
  a2
      ...
      // check parameter types:
      if (
        is_Qt_DockWidgetAreas(handler, a1
  )

   && is_QTabWidget_TabPosition(handler, a2
  )
...
QTabWidget::TabPosition a2_cpp;
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QMainWindow_DockOptions(handler, a1
  )
...
QMainWindow::DockOptions a1_cpp;
      ...
      a1_cpp = js2cpp_QMainWindow_DockOptions(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QMainWindow_DockOptions(
              handler, 
              // non-copyable: false
                  res
...
QPoint a1_cpp;
  ...
  // convert js parameter to cpp: menubar (QMenuBar)
      ...
      a1_cpp = js2cpp_QMenuBar_ptr(handler, a1);
  ...
  // convert js parameter to cpp: statusbar (QStatusBar)
      ...
      a1_cpp = js2cpp_QStatusBar_ptr(handler, a1);
  ...
  a2
      ...
      // check parameter types:
      if (
        is_Qt_Corner(handler, a1
  )

   && is_Qt_DockWidgetArea(handler, a2
  )
...
Qt::Corner a1_cpp;
      ...
      a1_cpp = js2cpp_Qt_Corner(handler, a1);
        
  // convert js parameter to cpp: area (Qt::DockWidgetArea)
  
Qt::DockWidgetArea a2_cpp;

      a2_cpp = js2cpp_Qt_DockWidgetArea(handler, a2);
...
Qt::Corner a1_cpp;
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_Qt_DockWidgetArea(
              handler, 
              // non-copyable: false
                  res
...
Qt::ToolBarArea a1_cpp;
          ...
          if (a1.isUndefined()) {
            ...
            a1_cpp = js2cpp_Qt_ToolBarArea(handler, a1);
          }
  ...
  // convert js parameter to cpp: before (QToolBar)
      ...
      a1_cpp = js2cpp_QToolBar_ptr(handler, a1);
...
Qt::ToolBarArea a1_cpp;
  ...
  // convert js parameter to cpp: toolbar (QToolBar)
      ...
      a2_cpp = js2cpp_QToolBar_ptr(handler, a2);
...
QString a1_cpp;
  ...
  a3
   ...
   && is_QDockWidget_ptr(handler, a2
    , true
  
  )

   && is_Qt_Orientation(handler, a3
  )
...
Qt::DockWidgetArea a1_cpp;
  ...
  // convert js parameter to cpp: dockwidget (QDockWidget)
      ...
      a2_cpp = js2cpp_QDockWidget_ptr(handler, a2);
        
  // convert js parameter to cpp: orientation (Qt::Orientation)
  
Qt::Orientation a3_cpp;

      a3_cpp = js2cpp_Qt_Orientation(handler, a3);
...
Qt::DockWidgetArea a1_cpp;
  ...
  // convert js parameter to cpp: after (QDockWidget)
      ...
      a1_cpp = js2cpp_QDockWidget_ptr(handler, a1);
...
Qt::Orientation a3_cpp;
  ...
  // convert js parameter to cpp: dockwidget (QDockWidget)
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QList_QDockWidget_ptr(
              handler, 
              // non-copyable: false
                  res
  ...
  a3
      ...
      // check parameter types:
      if (
        is_QList_QDockWidget_ptr(handler, a1
  )

   && is_QList_int(handler, a2
  )
...
QList<QDockWidget*> a1_cpp;
      ...
      a1_cpp = js2cpp_QList_QDockWidget_ptr(handler, a1);
        
  // convert js parameter to cpp: sizes (QList<int>)
  
QList<int> a2_cpp;

      a2_cpp = js2cpp_QList_int(handler, a2);
...
bool a1_cpp;
  ...
  QJSValue a1_js = cpp2js_Qt_ToolButtonStyle(
    handler, 
    toolButtonStyle
  );
  ...
  QJSValue a1_js = cpp2js_QDockWidget(
    handler, 
    dockWidget
  );
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QContextMenuEvent_ptr(handler, a1
    , true
  ...
  // convert js parameter to cpp: event (QContextMenuEvent)
      ...
      a1_cpp = js2cpp_QContextMenuEvent_ptr(handler, a1);
