...
QModelIndexList a1_cpp;
      ...
      a1_cpp = js2cpp_QModelIndexList(handler, a1);
...
Qt::MatchFlags a5_cpp;
          ...
          if (a5.isUndefined()) {
            ...
            a5_cpp = js2cpp_Qt_MatchFlags(handler, a5);
          }
...
Qt::SortOrder a2_cpp;
  ...
  QJSValue a1_js = cpp2js_Qt_CaseSensitivity(
    handler, 
