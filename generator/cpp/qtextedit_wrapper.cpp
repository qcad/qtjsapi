...
int a3_cpp;
  ...
  // convert js parameter to cpp:  (QWidget)
    ...
    void QTextEdit_Wrapper::init(RJSApi& handler) {
      ...
      QString fileName = ":generated/js/QTextEdit.js";
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                if (wb==nullptr) {
                  qWarning() << "QTextEdit::actionEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QTextEdit_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QTextEdit::setViewportMargins: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QTextEdit_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QTextEdit::viewportMargins: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QTextEdit_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QTextEdit::eventFilter: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QTextEdit_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QTextEdit::viewportEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QTextEdit_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QTextEdit::viewportSizeHint: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
...
QTextCharFormat a1_cpp;
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QTextEdit_AutoFormatting(
              handler, 
              // non-copyable: false
                  res
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QTextEdit_AutoFormatting(handler, a1
  )
...
QTextEdit::AutoFormatting a1_cpp;
      ...
      a1_cpp = js2cpp_QTextEdit_AutoFormatting(handler, a1);
...
bool a1_cpp;
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QTextEdit_LineWrapMode(
              handler, 
              // non-copyable: false
                  res
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QTextEdit_LineWrapMode(handler, a1
  )
...
QTextEdit::LineWrapMode a1_cpp;
      ...
      a1_cpp = js2cpp_QTextEdit_LineWrapMode(handler, a1);
...
int a1_cpp;
  ...
  QJSValue a1_js = cpp2js_QTextCharFormat(
    handler, 
    format
  );
