...
int a3_cpp;
  ...
  // convert js parameter to cpp:  (QWidget)
    ...
    void QMdiArea_Wrapper::init(RJSApi& handler) {
      ...
      QString fileName = ":generated/js/QMdiArea.js";
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                // call function of QMdiArea_Base class as 
                // function has postfix inheritable class, overridable function):
                QMdiArea_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QMdiArea::actionEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QMdiArea_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QMdiArea::setViewportMargins: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
...
QMargins a1_cpp;
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QMdiArea_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QMdiArea::viewportMargins: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QMdiArea_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QMdiArea::eventFilter: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QMdiArea_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QMdiArea::event: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QMdiArea_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QMdiArea::viewportEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QMdiArea_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QMdiArea::resizeEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QMdiArea_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QMdiArea::paintEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QMdiArea_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QMdiArea::mousePressEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QMdiArea_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QMdiArea::mouseReleaseEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QMdiArea_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QMdiArea::mouseDoubleClickEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QMdiArea_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QMdiArea::mouseMoveEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QMdiArea_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QMdiArea::wheelEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QMdiArea_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QMdiArea::dragEnterEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QMdiArea_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QMdiArea::keyPressEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QMdiArea_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QMdiArea::viewportSizeHint: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QMdiArea_WindowOrder(handler, a1
    , true
...
QMdiArea::WindowOrder a1_cpp;
          ...
          if (a1.isUndefined()) {
            ...
            a1_cpp = js2cpp_QMdiArea_WindowOrder(handler, a1);
          }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QList_QMdiSubWindow_ptr(
              handler, 
              // non-copyable: false
                  res
...
QBrush a1_cpp;
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QMdiArea_WindowOrder(
              handler, 
              // non-copyable: false
                  res
...
QMdiArea::WindowOrder a1_cpp;
  ...
  a2
      ...
      // check parameter types:
      if (
        is_QMdiArea_AreaOption(handler, a1
  )
...
QMdiArea::AreaOption a1_cpp;
      ...
      a1_cpp = js2cpp_QMdiArea_AreaOption(handler, a1);
...
QMdiArea::AreaOption a1_cpp;
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QMdiArea_ViewMode(handler, a1
  )
...
QMdiArea::ViewMode a1_cpp;
      ...
      a1_cpp = js2cpp_QMdiArea_ViewMode(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QMdiArea_ViewMode(
              handler, 
              // non-copyable: false
                  res
...
bool a1_cpp;
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QTabWidget_TabShape(handler, a1
  )
...
QTabWidget::TabShape a1_cpp;
      ...
      a1_cpp = js2cpp_QTabWidget_TabShape(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QTabWidget_TabShape(
              handler, 
              // non-copyable: false
                  res
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QTabWidget_TabPosition(handler, a1
  )
...
QTabWidget::TabPosition a1_cpp;
      ...
      a1_cpp = js2cpp_QTabWidget_TabPosition(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QTabWidget_TabPosition(
              handler, 
              // non-copyable: false
                  res
  ...
  QJSValue a1_js = cpp2js_QMdiSubWindow(
    handler, 
    a1
  );
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QMdiSubWindow_ptr(handler, a1
    , true
  ...
  // convert js parameter to cpp: window (QMdiSubWindow)
      ...
      a1_cpp = js2cpp_QMdiSubWindow_ptr(handler, a1);
