...
int a3_cpp;
  ...
  // convert js parameter to cpp:  (QWidget)
    ...
    void QSlider_Wrapper::init(RJSApi& handler) {
      ...
      QString fileName = ":generated/js/QSlider.js";
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                if (wb==nullptr) {
                  qWarning() << "QSlider::resizeEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QSlider_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QSlider::actionEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
...
int a2_cpp;
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QSlider_TickPosition(handler, a1
  )
...
QSlider::TickPosition a1_cpp;
      ...
      a1_cpp = js2cpp_QSlider_TickPosition(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QSlider_TickPosition(
              handler, 
              // non-copyable: false
                  res
