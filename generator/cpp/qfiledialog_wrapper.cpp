...
QString a4_cpp;
  ...
  a4
   ...
   && is_QFileDialog_Options(handler, a4
    , true
...
QFileDialog::Options a4_cpp;
          ...
          if (a4.isUndefined()) {
            ...
            a4_cpp = js2cpp_QFileDialog_Options(handler, a4);
          }
...
QStringList a5_cpp;
          ...
          if (a5.isUndefined()) {
            ...
            a5_cpp = js2cpp_QStringList(handler, a5);
          }
...
Qt::WidgetAttribute a1_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              QFileDialog_Wrapper::paintEngine
              (
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                // call function of QFileDialog_Base class as 
                // function has postfix inheritable class, overridable function):
                QFileDialog_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QFileDialog::mousePressEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QFileDialog_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QFileDialog::mouseReleaseEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QFileDialog_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QFileDialog::mouseMoveEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QFileDialog_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QFileDialog::paintEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QFileDialog_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QFileDialog::actionEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QFileDialog_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QFileDialog::resizeEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
...
QDir::Filters a1_cpp;
      ...
      a1_cpp = js2cpp_QDir_Filters(handler, a1);
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QFileDialog_ViewMode(handler, a1
  )
...
QFileDialog::ViewMode a1_cpp;
      ...
      a1_cpp = js2cpp_QFileDialog_ViewMode(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QFileDialog_ViewMode(
              handler, 
              // non-copyable: false
                  res
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QFileDialog_FileMode(handler, a1
  )
...
QFileDialog::FileMode a1_cpp;
      ...
      a1_cpp = js2cpp_QFileDialog_FileMode(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QFileDialog_FileMode(
              handler, 
              // non-copyable: false
                  res
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QFileDialog_AcceptMode(handler, a1
  )
...
QFileDialog::AcceptMode a1_cpp;
      ...
      a1_cpp = js2cpp_QFileDialog_AcceptMode(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QFileDialog_AcceptMode(
              handler, 
              // non-copyable: false
                  res
...
QList<QUrl> a1_cpp;
      ...
      a1_cpp = js2cpp_QList_QUrl(handler, a1);
...
QStringList a1_cpp;
  ...
  a2
      ...
      // check parameter types:
      if (
        is_QFileDialog_DialogLabel(handler, a1
  )
...
QFileDialog::DialogLabel a1_cpp;
      ...
      a1_cpp = js2cpp_QFileDialog_DialogLabel(handler, a1);
...
QStringList a1_cpp;
  ...
  a2
      ...
      // check parameter types:
      if (
        is_QFileDialog_Option(handler, a1
  )
...
QFileDialog::Option a1_cpp;
      ...
      a1_cpp = js2cpp_QFileDialog_Option(handler, a1);
...
QFileDialog::Option a1_cpp;
  ...
  a1
      ...
      // check parameter types:
      if (
        is_QFileDialog_Options(handler, a1
  )
...
QFileDialog::Options a1_cpp;
      ...
      a1_cpp = js2cpp_QFileDialog_Options(handler, a1);
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            return cpp2js_QFileDialog_Options(
              handler, 
              // non-copyable: false
                  res
...
bool a1_cpp;
  ...
  QJSValue a1_js = cpp2js_QStringList(
    handler, 
    files
  );
  ...
  QJSValue a1_js = cpp2js_QList_QUrl(
    handler, 
    urls
  );
