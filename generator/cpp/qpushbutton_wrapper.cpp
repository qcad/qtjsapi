...
int a3_cpp;
  ...
  // convert js parameter to cpp:  (QWidget)
    ...
    void QPushButton_Wrapper::init(RJSApi& handler) {
      ...
      QString fileName = ":generated/js/QPushButton.js";
...
Qt::WidgetAttribute a1_cpp;
    ...
    // preceding Parameters: -1
                ...
                QJSValue 
              QPushButton_Wrapper::paintEngine
              (
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                if (wb==nullptr) {
                  qWarning() << "QPushButton::mousePressEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QPushButton_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QPushButton::mouseReleaseEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QPushButton_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QPushButton::resizeEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
    ...
    // call function:
          ...
          if (!hasWrapped()) {
            ...
            // call function of wrapped object:
                ...
                QPushButton_Base* wb = getWrappedBase();
                if (wb==nullptr) {
                  qWarning() << "QPushButton::actionEvent: using base but wrapper is not of type of base class";
                  handler.trace();
                  return QJSValue();
                }
