  ...
  // preceding Parameters: -1
      ...
      void QToolButton_Base::mousePressEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QToolButton_Base::mousePressEvent()";
...
event
  ...
  void QToolButton_Base::mouseReleaseEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QToolButton_Base::mouseReleaseEvent()";
...
event
  ...
  void QToolButton_Base::mouseMoveEvent(
      QMouseEvent* event
    ) {

      //qDebug() << "QToolButton_Base::mouseMoveEvent()";
...
event
  ...
  void QToolButton_Base::paintEvent(
      QPaintEvent* event
    ) {

      //qDebug() << "QToolButton_Base::paintEvent()";
...
event
  ...
  void QToolButton_Base::resizeEvent(
      QResizeEvent* event
    ) {

      //qDebug() << "QToolButton_Base::resizeEvent()";
...
event
  ...
  void QToolButton_Base::actionEvent(
      QActionEvent* event
    ) {

      //qDebug() << "QToolButton_Base::actionEvent()";
