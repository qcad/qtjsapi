  ...
  // Auto generated
    ...
    #ifndef QHELPINDEXWIDGET_H_WRAPPER
    #define QHELPINDEXWIDGET_H_WRAPPER
    ...
    // wrapper class for QHelpIndexWidget
    class QTJSAPI_EXPORT QHelpIndexWidget_Wrapper : public RJSWrapperObj {
  ...
  Q_PROPERTY(
    ...
    private:
      ...
      QHelpIndexWidget_Wrapper(const QHelpIndexWidget_Wrapper&);

    public:
      // initialization of QHelpIndexWidget:
      static void init(RJSApi& handler);

      
        static QHelpIndexWidget* castToBase(void* vp, /*RJSType ID*/ int t) {
          
            // check if pointer points to derrived type:
            

          // hook for modules to cast from other types to base QHelpIndexWidget:
          for (int i=0; i<basecasters_QHelpIndexWidget.length(); i++) {
            RJSBasecaster_QHelpIndexWidget* basecaster = basecasters_QHelpIndexWidget[i];
            QHelpIndexWidget* ret = basecaster->castToBase(t, vp);
            if (ret!=nullptr) {
              return ret;
            }
          }

          // object is a pointer to base class QHelpIndexWidget:
          if (t==RJSType_QHelpIndexWidget::getIdStatic()) {
            return (QHelpIndexWidget*)vp;
          }

          qWarning() << "QHelpIndexWidget_Wrapper::castToBase: type not found: " << RJSHelper::getTypeName(t);

          return nullptr;
          
        }

        static QHelpIndexWidget* getWrappedBase(RJSWrapper* wrapper) {
          int t = wrapper->getWrappedType();
          void* vp = wrapper->getWrappedVoid();
          if (vp==nullptr) {
              //qWarning() << "getWrapped_QHelpIndexWidget*: wrapper wraps NULL";
          }

          QHelpIndexWidget* ret = castToBase(vp, t);
          if (ret==nullptr && vp!=nullptr) {
              qWarning() << "QHelpIndexWidget*_Wrapper::getWrappedBase: extracted type " << t << "from wrapper is NULL";
          }
          return ret;
        }
  ...
  enum Shape {
    NoFrame = QHelpIndexWidget::NoFrame,
Box = QHelpIndexWidget::Box,
Panel = QHelpIndexWidget::Panel,
WinPanel = QHelpIndexWidget::WinPanel,
HLine = QHelpIndexWidget::HLine,
VLine = QHelpIndexWidget::VLine,
StyledPanel = QHelpIndexWidget::StyledPanel,

  };
  Q_ENUM(Shape)

  enum Shadow {
    Plain = QHelpIndexWidget::Plain,
Raised = QHelpIndexWidget::Raised,
Sunken = QHelpIndexWidget::Sunken,

  };
  Q_ENUM(Shadow)

  enum StyleMask {
    Shadow_Mask = QHelpIndexWidget::Shadow_Mask,
Shape_Mask = QHelpIndexWidget::Shape_Mask,

  };
  Q_ENUM(StyleMask)

  enum SizeAdjustPolicy {
    AdjustIgnored = QHelpIndexWidget::AdjustIgnored,
AdjustToContentsOnFirstShow = QHelpIndexWidget::AdjustToContentsOnFirstShow,
AdjustToContents = QHelpIndexWidget::AdjustToContents,

  };
  Q_ENUM(SizeAdjustPolicy)

  enum SelectionMode {
    NoSelection = QHelpIndexWidget::NoSelection,
SingleSelection = QHelpIndexWidget::SingleSelection,
MultiSelection = QHelpIndexWidget::MultiSelection,
ExtendedSelection = QHelpIndexWidget::ExtendedSelection,
ContiguousSelection = QHelpIndexWidget::ContiguousSelection,

  };
  Q_ENUM(SelectionMode)

  enum SelectionBehavior {
    SelectItems = QHelpIndexWidget::SelectItems,
SelectRows = QHelpIndexWidget::SelectRows,
SelectColumns = QHelpIndexWidget::SelectColumns,

  };
  Q_ENUM(SelectionBehavior)

  enum ScrollHint {
    EnsureVisible = QHelpIndexWidget::EnsureVisible,
PositionAtTop = QHelpIndexWidget::PositionAtTop,
PositionAtBottom = QHelpIndexWidget::PositionAtBottom,
PositionAtCenter = QHelpIndexWidget::PositionAtCenter,

  };
  Q_ENUM(ScrollHint)

  enum EditTrigger {
    NoEditTriggers = QHelpIndexWidget::NoEditTriggers,
CurrentChanged = QHelpIndexWidget::CurrentChanged,
DoubleClicked = QHelpIndexWidget::DoubleClicked,
SelectedClicked = QHelpIndexWidget::SelectedClicked,
EditKeyPressed = QHelpIndexWidget::EditKeyPressed,
AnyKeyPressed = QHelpIndexWidget::AnyKeyPressed,
AllEditTriggers = QHelpIndexWidget::AllEditTriggers,

  };
  Q_ENUM(EditTrigger)

  enum ScrollMode {
    ScrollPerItem = QHelpIndexWidget::ScrollPerItem,
ScrollPerPixel = QHelpIndexWidget::ScrollPerPixel,

  };
  Q_ENUM(ScrollMode)

  enum DragDropMode {
    NoDragDrop = QHelpIndexWidget::NoDragDrop,
DragOnly = QHelpIndexWidget::DragOnly,
DropOnly = QHelpIndexWidget::DropOnly,
DragDrop = QHelpIndexWidget::DragDrop,
InternalMove = QHelpIndexWidget::InternalMove,

  };
  Q_ENUM(DragDropMode)

  enum Movement {
    Static = QHelpIndexWidget::Static,
Free = QHelpIndexWidget::Free,
Snap = QHelpIndexWidget::Snap,

  };
  Q_ENUM(Movement)

  enum Flow {
    LeftToRight = QHelpIndexWidget::LeftToRight,
TopToBottom = QHelpIndexWidget::TopToBottom,

  };
  Q_ENUM(Flow)

  enum ResizeMode {
    Fixed = QHelpIndexWidget::Fixed,
Adjust = QHelpIndexWidget::Adjust,

  };
  Q_ENUM(ResizeMode)

  enum LayoutMode {
    SinglePass = QHelpIndexWidget::SinglePass,
Batched = QHelpIndexWidget::Batched,

  };
  Q_ENUM(LayoutMode)

  enum ViewMode {
    ListMode = QHelpIndexWidget::ListMode,
IconMode = QHelpIndexWidget::IconMode,
  ...
  Q_ENUM(ViewMode)
    ...
    // special constructor used as prototype:
          ...
          Q_INVOKABLE 
          QHelpIndexWidget_Wrapper(QJSEngine* e);
    ...
    */
      ...
      // special constructor to wrap existing object:
            ...
            //Q_INVOKABLE 
            QHelpIndexWidget_Wrapper(RJSApi& h, QHelpIndexWidget* o, bool wrappedCreated);
          

      // destructor:
      
          virtual ~QHelpIndexWidget_Wrapper();
  ...
  a2
              ...
              // called when signal is emitted from wrapped class:
              public slots:
              void documentsActivatedEmitter(
  ...
  // protected overwritten functions / events and their public invokable counterparts:
        ...
        QHelpIndexWidget* getWrapped() const {
      ...
      private:
        ...
        static QList<RJSBasecaster_QHelpIndexWidget*> basecasters_QHelpIndexWidget;

      public:
        static void registerBasecaster_QHelpIndexWidget(RJSBasecaster_QHelpIndexWidget* bc) {
          basecasters_QHelpIndexWidget.append(bc);
        }
      
    };

    Q_DECLARE_METATYPE(QHelpIndexWidget_Wrapper*)

    Q_DECLARE_INTERFACE(QHelpIndexWidget_Wrapper, "org.qcad.QHelpIndexWidget_Wrapper")
